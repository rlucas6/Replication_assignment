...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal2007_is_data_stata.csv", comma clear
label data "dct_sal2007_a"
...
save "$PATH\Academic Calendar\Data\faculty2007.dta", replace
