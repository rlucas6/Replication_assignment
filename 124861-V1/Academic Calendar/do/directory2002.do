...
*                                            
clear            
insheet using "$PATH\Academic Calendar\Data\hd2002_data_stata.csv", comma clear
...
label define label_fips 1 "AL", replace
...
label define label_obereg 0 "US Service schools", replace
...
label define label_opeflag 1 "Participates in Title IV federal financial aid programs", replace
...
label define label_sector 0 "Administrative Unit Only", replace
...
gen year=2002
sort unitid
save "$PATH\Academic Calendar\Data\directory2002.dta", replace
