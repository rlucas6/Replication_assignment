...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2012_is_data_stata.csv", comma clear
label data "dct_sal2012_is"
...
save "$PATH\Academic Calendar\Data\faculty2012.dta", replace
