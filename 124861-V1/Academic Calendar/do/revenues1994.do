...
insheet using f1994_a_data_stata.csv, comma clear
label data "dct_f1994_a"
...
label variable xa011 "Imputation field for A011 - Tuition and fees"
label variable xa012 "Imputation field for A012 - Tuition and fees"
label variable xa013 "Imputation field for A013 - Tuition and fees"
label variable xa021 "Imputation field for A021 - Government appropriations, federal unrestricted"
label variable xa022 "Imputation field for A022 - Government appropriations, federal restricted"
label variable xa023 "Imputation field for A023 - Government appropriations, federal total"
label variable xa041 "Imputation field for A041 - Government appropriations state unrestricted"
label variable xa042 "Imputation field for A042 - Government appropriations state restricted"
label variable xa043 "Imputation field for A043 - Government appropriations state total"
label variable xa051 "Imputation field for A051 - Government appropriations local unrestricted"
label variable xa052 "Imputation field for A052 - Government appropriations local restricted"
label variable xa053 "Imputation field for A053 - Government appropriations local total"
label variable xa061 "Imputation field for A061 - Government grants and contracts federal unrestricted"
label variable xa062 "Imputation field for A062 - Government grants and contracts federal restricted"
label variable xa063 "Imputation field for A063 - Government grants and contracts federal total"
label variable xa071 "Imputation field for A071 - Government grants and contracts state unrestricted"
label variable xa072 "Imputation field for A072 - Government grants and contracts state restricted"
label variable xa073 "Imputation field for A073 - Government grants and contracts state total"
label variable xa081 "Imputation field for A081 - Government grants and contracts local unrestricted"
label variable xa082 "Imputation field for A082 - Government grants and contracts local restricted"
label variable xa083 "Imputation field for A083 - Government grants and contracts local total"
...
label define label_xa011 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa012 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa013 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa021 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa022 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa023 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa041 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa042 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa043 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa051 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa052 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa053 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa061 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa062 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa063 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa071 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa072 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa073 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa081 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa082 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa083 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa091 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa092 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa093 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa101 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa102 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa103 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa111 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa112 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa113 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa121 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa122 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa123 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa131 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa132 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa133 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa141 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa142 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa143 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa151 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa152 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa153 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa161 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa162 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xa163 25 "Imputed for an item that was previously reported using data from prior year", add 
...
label define label_xaline03 25 "Imputed for an item that was previously reported using data from prior year", add 
