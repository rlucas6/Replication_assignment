...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\ic2002_ay_data_stata.csv", comma clear
label data "dct_ic2002_ay"
...
label variable xfee6 "Imputation field for FEE6 - In-state required fees full-time graduates"
label variable fee6 "In-state required fees full-time graduates"
...
label variable xfee7 "Imputation field for FEE7 - Out-of-state required fees full-time graduates"
label variable fee7 "Out-of-state required fees full-time graduates"
...
label variable xchg1ay1 "Imputation field for chg1ay1 - Published in-district tuition and fees 2000-01"
label variable chg1ay1 "Published in-district tuition and fees 2000-01"
label variable xchg1ay2 "Imputation field for chg1ay2 - Published in-district tuition and fees 2001-02"
label variable chg1ay2 "Published in-district tuition and fees 2001-02"
label variable xchg1ay3 "Imputation field for chg1ay3 - Published in-district tuition and fees 2002-03"
label variable chg1ay3 "Published in-district tuition and fees 2002-03"
label variable xchg2ay1 "Imputation field for chg2ay1 - Published in-state  tuition and fees 2000-01"
label variable chg2ay1 "Published in-state  tuition and fees 2000-01"
label variable xchg2ay2 "Imputation field for chg2ay2 - Published in-state  tuition and fees 2001-02"
label variable chg2ay2 "Published in-state  tuition and fees 2001-02"
label variable xchg2ay3 "Imputation field for chg2ay3 - Published in-state  tuition and fees 2002-03"
label variable chg2ay3 "Published in-state  tuition and fees 2002-03"
label variable xchg3ay1 "Imputation field for chg3ay1 - Published out-of-state  tuition and fees 2000-01"
label variable chg3ay1 "Published out-of-state  tuition and fees 2000-01"
label variable xchg3ay2 "Imputation field for chg3ay2 - Published out-of-state  tuition and fees 2001-02"
label variable chg3ay2 "Published out-of-state  tuition and fees 2001-02"
label variable xchg3ay3 "Imputation field for chg3ay3 - Published out-of-state  tuition and fees 2002-03"
label variable chg3ay3 "Published out-of-state  tuition and fees 2002-03"
label variable xchg4ay1 "Imputation field for chg4ay1 - Books and supplies 2000-01"
label variable chg4ay1 "Books and supplies 2000-01"
label variable xchg4ay2 "Imputation field for chg4ay2 - Books and supplies 2001-02"
label variable chg4ay2 "Books and supplies 2001-02"
label variable xchg4ay3 "Imputation field for chg4ay3 - Books and supplies 2002-03"
label variable chg4ay3 "Books and supplies 2002-03"
label variable xchg5ay1 "Imputation field for chg5ay1 - On campus, room and board 2000-01"
label variable chg5ay1 "On campus, room and board 2000-01"
label variable xchg5ay2 "Imputation field for chg5ay2 - On campus, room and board 2001-02"
label variable chg5ay2 "On campus, room and board 2001-02"
label variable xchg5ay3 "Imputation field for chg5ay3 - On campus, room and board 2002-03"
label variable chg5ay3 "On campus, room and board 2002-03"
label variable xchg6ay1 "Imputation field for chg6ay1 - On campus, other expenses 2000-01"
label variable chg6ay1 "On campus, other expenses 2000-01"
label variable xchg6ay2 "Imputation field for chg6ay2 - On campus, other expenses 2001-02"
label variable chg6ay2 "On campus, other expenses 2001-02"
label variable xchg6ay3 "Imputation field for chg6ay3 - On campus, other expenses 2002-03"
label variable chg6ay3 "On campus, other expenses 2002-03"
label variable xchg7ay1 "Imputation field for chg7ay1 - Off campus (not with family), room and board  2000-01"
label variable chg7ay1 "Off campus (not with family), room and board  2000-01"
label variable xchg7ay2 "Imputation field for chg7ay2 - Off campus (not with family), room and board 2001-02"
label variable chg7ay2 "Off campus (not with family), room and board 2001-02"
label variable xchg7ay3 "Imputation field for chg7ay3 - Off campus (not with family), room and board 2002-03"
label variable chg7ay3 "Off campus (not with family), room and board 2002-03"
label variable xchg8ay1 "Imputation field for chg8ay1 - Off campus (not with family), other expenses 2000-01"
label variable chg8ay1 "Off campus (not with family), other expenses 2000-01"
label variable xchg8ay2 "Imputation field for chg8ay2 - Off campus (not with family), other expenses 2001-02"
label variable chg8ay2 "Off campus (not with family), other expenses 2001-02"
label variable xchg8ay3 "Imputation field for chg8ay3 - Off campus (not with family), other expenses 2002-03"
label variable chg8ay3 "Off campus (not with family), other expenses 2002-03"
label variable xchg9ay1 "Imputation field for chg9ay1 - Off campus (with family), other expenses -2000-01"
label variable chg9ay1 "Off campus (with family), other expenses -2000-01"
label variable xchg9ay2 "Imputation field for chg9ay2 - Off campus (with family), other expenses 2001-02"
label variable chg9ay2 "Off campus (with family), other expenses 2001-02"
label variable xchg9ay3 "Imputation field for chg9ay3 - Off campus (with family), other expenses 2002-03"
label variable chg9ay3 "Off campus (with family), other expenses 2002-03"
...
gen year=2002
save "$PATH\Academic Calendar\Data\tuition2002.dta", replace
