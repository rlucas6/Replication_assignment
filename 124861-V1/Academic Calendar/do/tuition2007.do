...
*                   
clear                                     
insheet using "$PATH\Academic Calendar\Data\ic2007_ay_data_stata.csv", comma clear
label data "dct_ic2007_ay"
...
label variable xchg1ay1 "Imputation field for chg1ay1 - Published in-district tuition and fees 2005-06"
label variable chg1ay1 "Published in-district tuition and fees 2005-06"
label variable xchg1ay2 "Imputation field for chg1ay2 - Published in-district tuition and fees 2006-07"
label variable chg1ay2 "Published in-district tuition and fees 2006-07"
label variable xchg1ay3 "Imputation field for chg1ay3 - Published in-district tuition and fees 2007-08"
label variable chg1ay3 "Published in-district tuition and fees 2007-08"
label variable xchg2ay1 "Imputation field for chg2ay1 - Published in-state  tuition and fees 2005-06"
label variable chg2ay1 "Published in-state  tuition and fees 2005-06"
label variable xchg2ay2 "Imputation field for chg2ay2 - Published in-state  tuition and fees 2006-07"
label variable chg2ay2 "Published in-state  tuition and fees 2006-07"
label variable xchg2ay3 "Imputation field for chg2ay3 - Published in-state  tuition and fees 2007-08"
label variable chg2ay3 "Published in-state  tuition and fees 2007-08"
label variable xchg3ay1 "Imputation field for chg3ay1 - Published out-of-state  tuition and fees 2005-06"
label variable chg3ay1 "Published out-of-state  tuition and fees 2005-06"
label variable xchg3ay2 "Imputation field for chg3ay2 - Published out-of-state  tuition and fees 2006-07"
label variable chg3ay2 "Published out-of-state  tuition and fees 2006-07"
label variable xchg3ay3 "Imputation field for chg3ay3 - Published out-of-state  tuition and fees 2007-08"
label variable chg3ay3 "Published out-of-state  tuition and fees 2007-08"
label variable xchg4ay1 "Imputation field for chg4ay1 - Books and supplies 2005-06"
label variable chg4ay1 "Books and supplies 2005-06"
label variable xchg4ay2 "Imputation field for chg4ay2 - Books and supplies 2006-07"
label variable chg4ay2 "Books and supplies 2006-07"
label variable xchg4ay3 "Imputation field for chg4ay3 - Books and supplies 2007-08"
label variable chg4ay3 "Books and supplies 2007-08"
label variable xchg5ay1 "Imputation field for chg5ay1 - On campus, room and board 2005-06"
label variable chg5ay1 "On campus, room and board 2005-06"
label variable xchg5ay2 "Imputation field for chg5ay2 - On campus, room and board 2006-07"
label variable chg5ay2 "On campus, room and board 2006-07"
label variable xchg5ay3 "Imputation field for chg5ay3 - On campus, room and board 2007-08"
label variable chg5ay3 "On campus, room and board 2007-08"
label variable xchg6ay1 "Imputation field for chg6ay1 - On campus, other expenses 2005-06"
label variable chg6ay1 "On campus, other expenses 2005-06"
label variable xchg6ay2 "Imputation field for chg6ay2 - On campus, other expenses 2006-07"
label variable chg6ay2 "On campus, other expenses 2006-07"
label variable xchg6ay3 "Imputation field for chg6ay3 - On campus, other expenses 2007-08"
label variable chg6ay3 "On campus, other expenses 2007-08"
label variable xchg7ay1 "Imputation field for chg7ay1 - Off campus (not with family), room and board  2005-06"
label variable chg7ay1 "Off campus (not with family), room and board  2005-06"
label variable xchg7ay2 "Imputation field for chg7ay2 - Off campus (not with family), room and board 2006-07"
label variable chg7ay2 "Off campus (not with family), room and board 2006-07"
label variable xchg7ay3 "Imputation field for chg7ay3 - Off campus (not with family), room and board 2007-08"
label variable chg7ay3 "Off campus (not with family), room and board 2007-08"
label variable xchg8ay1 "Imputation field for chg8ay1 - Off campus (not with family), other expenses 2005-06"
label variable chg8ay1 "Off campus (not with family), other expenses 2005-06"
label variable xchg8ay2 "Imputation field for chg8ay2 - Off campus (not with family), other expenses 2006-07"
label variable chg8ay2 "Off campus (not with family), other expenses 2006-07"
label variable xchg8ay3 "Imputation field for chg8ay3 - Off campus (not with family), other expenses 2007-08"
label variable chg8ay3 "Off campus (not with family), other expenses 2007-08"
label variable xchg9ay1 "Imputation field for chg9ay1 - Off campus (with family), other expenses 2004-05"
label variable chg9ay1 "Off campus (with family), other expenses 2004-05"
label variable xchg9ay2 "Imputation field for chg9ay2 - Off campus (with family), other expenses 2006-07"
label variable chg9ay2 "Off campus (with family), other expenses 2006-07"
label variable xchg9ay3 "Imputation field for chg9ay3 - Off campus (with family), other expenses 2007-08"
label variable chg9ay3 "Off campus (with family), other expenses 2007-08"
label variable xcmp1ay1 "Imputation field for CMP1AY1 - In-district comprehensive fee 2005-06"
label variable cmp1ay1 "In-district comprehensive fee 2005-06"
label variable xcmp1ay2 "Imputation field for CMP1AY2 - In-district comprehensive fee 2006-07"
label variable cmp1ay2 "In-district comprehensive fee 2006-07"
label variable xcmp1ay3 "Imputation field for CMP1AY3 - In-district comprehensive fee 2007-08"
label variable cmp1ay3 "In-district comprehensive fee 2007-08"
label variable xcmp2ay1 "Imputation field for CMP2AY1 - In-state comprehensive fee 2005-06"
label variable cmp2ay1 "In-state comprehensive fee 2005-06"
label variable xcmp2ay2 "Imputation field for CMP2AY2 - In-state comprehensive fee 2006-07"
label variable cmp2ay2 "In-state comprehensive fee 2006-07"
label variable xcmp2ay3 "Imputation field for CMP2AY3 - In-state comprehensive fee 2007-08"
label variable cmp2ay3 "In-state comprehensive fee 2007-08"
label variable xcmp3ay1 "Imputation field for CMP3AY1 - Out-of-state comprehensive fee 2005-06"
label variable cmp3ay1 "Out-of-state comprehensive fee 2005-06"
label variable xcmp3ay2 "Imputation field for CMP3AY2 - Out-of-state comprehensive fee 2006-07"
label variable cmp3ay2 "Out-of-state comprehensive fee 2006-07"
label variable xcmp3ay3 "Imputation field for CMP3AY3 - Out-of-state comprehensive fee 2007-08"
label variable cmp3ay3 "Out-of-state comprehensive fee 2007-08"
/*
...
label define label_xtuit1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit1 50 "Outlier value derived from reported data", add 
label define label_xtuit1 51 "Outlier value derived from imported data", add 
label define label_xtuit1 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit1 53 "Value not derived - data not usable", add 
...
label define label_xfee1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee1 50 "Outlier value derived from reported data", add 
label define label_xfee1 51 "Outlier value derived from imported data", add 
label define label_xfee1 52 "Value not derived - parent/child differs across components", add 
label define label_xfee1 53 "Value not derived - data not usable", add 
...
label define label_xhrchg1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg1 50 "Outlier value derived from reported data", add 
label define label_xhrchg1 51 "Outlier value derived from imported data", add 
label define label_xhrchg1 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg1 53 "Value not derived - data not usable", add 
...
label define label_xcmpfee1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcmpfee1 50 "Outlier value derived from reported data", add 
label define label_xcmpfee1 51 "Outlier value derived from imported data", add 
label define label_xcmpfee1 52 "Value not derived - parent/child differs across components", add 
label define label_xcmpfee1 53 "Value not derived - data not usable", add 
...
label define label_xtuit2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit2 50 "Outlier value derived from reported data", add 
label define label_xtuit2 51 "Outlier value derived from imported data", add 
label define label_xtuit2 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit2 53 "Value not derived - data not usable", add 
...
label define label_xfee2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee2 50 "Outlier value derived from reported data", add 
label define label_xfee2 51 "Outlier value derived from imported data", add 
label define label_xfee2 52 "Value not derived - parent/child differs across components", add 
label define label_xfee2 53 "Value not derived - data not usable", add 
...
label define label_xhrchg2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg2 50 "Outlier value derived from reported data", add 
label define label_xhrchg2 51 "Outlier value derived from imported data", add 
label define label_xhrchg2 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg2 53 "Value not derived - data not usable", add 
...
label define label_xcmpfee2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcmpfee2 50 "Outlier value derived from reported data", add 
label define label_xcmpfee2 51 "Outlier value derived from imported data", add 
label define label_xcmpfee2 52 "Value not derived - parent/child differs across components", add 
label define label_xcmpfee2 53 "Value not derived - data not usable", add 
...
label define label_xtuit3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit3 50 "Outlier value derived from reported data", add 
label define label_xtuit3 51 "Outlier value derived from imported data", add 
label define label_xtuit3 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit3 53 "Value not derived - data not usable", add 
...
label define label_xfee3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee3 50 "Outlier value derived from reported data", add 
label define label_xfee3 51 "Outlier value derived from imported data", add 
label define label_xfee3 52 "Value not derived - parent/child differs across components", add 
label define label_xfee3 53 "Value not derived - data not usable", add 
...
label define label_xhrchg3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg3 50 "Outlier value derived from reported data", add 
label define label_xhrchg3 51 "Outlier value derived from imported data", add 
label define label_xhrchg3 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg3 53 "Value not derived - data not usable", add 
...
label define label_xcmpfee3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xcmpfee3 50 "Outlier value derived from reported data", add 
label define label_xcmpfee3 51 "Outlier value derived from imported data", add 
label define label_xcmpfee3 52 "Value not derived - parent/child differs across components", add 
label define label_xcmpfee3 53 "Value not derived - data not usable", add 
...
label define label_xtuit5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit5 50 "Outlier value derived from reported data", add 
label define label_xtuit5 51 "Outlier value derived from imported data", add 
label define label_xtuit5 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit5 53 "Value not derived - data not usable", add 
...
label define label_xfee5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee5 50 "Outlier value derived from reported data", add 
label define label_xfee5 51 "Outlier value derived from imported data", add 
label define label_xfee5 52 "Value not derived - parent/child differs across components", add 
label define label_xfee5 53 "Value not derived - data not usable", add 
...
label define label_xhrchg5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg5 50 "Outlier value derived from reported data", add 
label define label_xhrchg5 51 "Outlier value derived from imported data", add 
label define label_xhrchg5 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg5 53 "Value not derived - data not usable", add 
...
label define label_xtuit6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit6 50 "Outlier value derived from reported data", add 
label define label_xtuit6 51 "Outlier value derived from imported data", add 
label define label_xtuit6 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit6 53 "Value not derived - data not usable", add 
...
label define label_xfee6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee6 50 "Outlier value derived from reported data", add 
label define label_xfee6 51 "Outlier value derived from imported data", add 
label define label_xfee6 52 "Value not derived - parent/child differs across components", add 
label define label_xfee6 53 "Value not derived - data not usable", add 
...
label define label_xhrchg6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg6 50 "Outlier value derived from reported data", add 
label define label_xhrchg6 51 "Outlier value derived from imported data", add 
label define label_xhrchg6 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg6 53 "Value not derived - data not usable", add 
...
label define label_xtuit7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xtuit7 50 "Outlier value derived from reported data", add 
label define label_xtuit7 51 "Outlier value derived from imported data", add 
label define label_xtuit7 52 "Value not derived - parent/child differs across components", add 
label define label_xtuit7 53 "Value not derived - data not usable", add 
...
label define label_xfee7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xfee7 50 "Outlier value derived from reported data", add 
label define label_xfee7 51 "Outlier value derived from imported data", add 
label define label_xfee7 52 "Value not derived - parent/child differs across components", add 
label define label_xfee7 53 "Value not derived - data not usable", add 
...
label define label_xhrchg7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xhrchg7 50 "Outlier value derived from reported data", add 
label define label_xhrchg7 51 "Outlier value derived from imported data", add 
label define label_xhrchg7 52 "Value not derived - parent/child differs across components", add 
label define label_xhrchg7 53 "Value not derived - data not usable", add 
...
label define label_xispro1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro1 50 "Outlier value derived from reported data", add 
label define label_xispro1 51 "Outlier value derived from imported data", add 
label define label_xispro1 52 "Value not derived - parent/child differs across components", add 
label define label_xispro1 53 "Value not derived - data not usable", add 
...
label define label_xispfe1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe1 50 "Outlier value derived from reported data", add 
label define label_xispfe1 51 "Outlier value derived from imported data", add 
label define label_xispfe1 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe1 53 "Value not derived - data not usable", add 
...
label define label_xospro1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro1 50 "Outlier value derived from reported data", add 
label define label_xospro1 51 "Outlier value derived from imported data", add 
label define label_xospro1 52 "Value not derived - parent/child differs across components", add 
label define label_xospro1 53 "Value not derived - data not usable", add 
...
label define label_xospfe1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe1 50 "Outlier value derived from reported data", add 
label define label_xospfe1 51 "Outlier value derived from imported data", add 
label define label_xospfe1 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe1 53 "Value not derived - data not usable", add 
...
label define label_xispro2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro2 50 "Outlier value derived from reported data", add 
label define label_xispro2 51 "Outlier value derived from imported data", add 
label define label_xispro2 52 "Value not derived - parent/child differs across components", add 
label define label_xispro2 53 "Value not derived - data not usable", add 
...
label define label_xispfe2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe2 50 "Outlier value derived from reported data", add 
label define label_xispfe2 51 "Outlier value derived from imported data", add 
label define label_xispfe2 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe2 53 "Value not derived - data not usable", add 
...
label define label_xospro2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro2 50 "Outlier value derived from reported data", add 
label define label_xospro2 51 "Outlier value derived from imported data", add 
label define label_xospro2 52 "Value not derived - parent/child differs across components", add 
label define label_xospro2 53 "Value not derived - data not usable", add 
...
label define label_xospfe2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe2 50 "Outlier value derived from reported data", add 
label define label_xospfe2 51 "Outlier value derived from imported data", add 
label define label_xospfe2 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe2 53 "Value not derived - data not usable", add 
...
label define label_xispro3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro3 50 "Outlier value derived from reported data", add 
label define label_xispro3 51 "Outlier value derived from imported data", add 
label define label_xispro3 52 "Value not derived - parent/child differs across components", add 
label define label_xispro3 53 "Value not derived - data not usable", add 
...
label define label_xispfe3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe3 50 "Outlier value derived from reported data", add 
label define label_xispfe3 51 "Outlier value derived from imported data", add 
label define label_xispfe3 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe3 53 "Value not derived - data not usable", add 
...
label define label_xospro3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro3 50 "Outlier value derived from reported data", add 
label define label_xospro3 51 "Outlier value derived from imported data", add 
label define label_xospro3 52 "Value not derived - parent/child differs across components", add 
label define label_xospro3 53 "Value not derived - data not usable", add 
...
label define label_xospfe3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe3 50 "Outlier value derived from reported data", add 
label define label_xospfe3 51 "Outlier value derived from imported data", add 
label define label_xospfe3 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe3 53 "Value not derived - data not usable", add 
...
label define label_xispro4 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro4 50 "Outlier value derived from reported data", add 
label define label_xispro4 51 "Outlier value derived from imported data", add 
label define label_xispro4 52 "Value not derived - parent/child differs across components", add 
label define label_xispro4 53 "Value not derived - data not usable", add 
...
label define label_xispfe4 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe4 50 "Outlier value derived from reported data", add 
label define label_xispfe4 51 "Outlier value derived from imported data", add 
label define label_xispfe4 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe4 53 "Value not derived - data not usable", add 
...
label define label_xospro4 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro4 50 "Outlier value derived from reported data", add 
label define label_xospro4 51 "Outlier value derived from imported data", add 
label define label_xospro4 52 "Value not derived - parent/child differs across components", add 
label define label_xospro4 53 "Value not derived - data not usable", add 
...
label define label_xospfe4 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe4 50 "Outlier value derived from reported data", add 
label define label_xospfe4 51 "Outlier value derived from imported data", add 
label define label_xospfe4 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe4 53 "Value not derived - data not usable", add 
...
label define label_xispro5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro5 50 "Outlier value derived from reported data", add 
label define label_xispro5 51 "Outlier value derived from imported data", add 
label define label_xispro5 52 "Value not derived - parent/child differs across components", add 
label define label_xispro5 53 "Value not derived - data not usable", add 
...
label define label_xispfe5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe5 50 "Outlier value derived from reported data", add 
label define label_xispfe5 51 "Outlier value derived from imported data", add 
label define label_xispfe5 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe5 53 "Value not derived - data not usable", add 
...
label define label_xospro5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro5 50 "Outlier value derived from reported data", add 
label define label_xospro5 51 "Outlier value derived from imported data", add 
label define label_xospro5 52 "Value not derived - parent/child differs across components", add 
label define label_xospro5 53 "Value not derived - data not usable", add 
...
label define label_xospfe5 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe5 50 "Outlier value derived from reported data", add 
label define label_xospfe5 51 "Outlier value derived from imported data", add 
label define label_xospfe5 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe5 53 "Value not derived - data not usable", add 
...
label define label_xispro6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro6 50 "Outlier value derived from reported data", add 
label define label_xispro6 51 "Outlier value derived from imported data", add 
label define label_xispro6 52 "Value not derived - parent/child differs across components", add 
label define label_xispro6 53 "Value not derived - data not usable", add 
...
label define label_xispfe6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe6 50 "Outlier value derived from reported data", add 
label define label_xispfe6 51 "Outlier value derived from imported data", add 
label define label_xispfe6 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe6 53 "Value not derived - data not usable", add 
...
label define label_xospro6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro6 50 "Outlier value derived from reported data", add 
label define label_xospro6 51 "Outlier value derived from imported data", add 
label define label_xospro6 52 "Value not derived - parent/child differs across components", add 
label define label_xospro6 53 "Value not derived - data not usable", add 
...
label define label_xospfe6 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe6 50 "Outlier value derived from reported data", add 
label define label_xospfe6 51 "Outlier value derived from imported data", add 
label define label_xospfe6 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe6 53 "Value not derived - data not usable", add 
...
label define label_xispro7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro7 50 "Outlier value derived from reported data", add 
label define label_xispro7 51 "Outlier value derived from imported data", add 
label define label_xispro7 52 "Value not derived - parent/child differs across components", add 
label define label_xispro7 53 "Value not derived - data not usable", add 
...
label define label_xispfe7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe7 50 "Outlier value derived from reported data", add 
label define label_xispfe7 51 "Outlier value derived from imported data", add 
label define label_xispfe7 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe7 53 "Value not derived - data not usable", add 
...
label define label_xospro7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro7 50 "Outlier value derived from reported data", add 
label define label_xospro7 51 "Outlier value derived from imported data", add 
label define label_xospro7 52 "Value not derived - parent/child differs across components", add 
label define label_xospro7 53 "Value not derived - data not usable", add 
...
label define label_xospfe7 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe7 50 "Outlier value derived from reported data", add 
label define label_xospfe7 51 "Outlier value derived from imported data", add 
label define label_xospfe7 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe7 53 "Value not derived - data not usable", add 
...
label define label_xispro8 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro8 50 "Outlier value derived from reported data", add 
label define label_xispro8 51 "Outlier value derived from imported data", add 
label define label_xispro8 52 "Value not derived - parent/child differs across components", add 
label define label_xispro8 53 "Value not derived - data not usable", add 
...
label define label_xispfe8 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe8 50 "Outlier value derived from reported data", add 
label define label_xispfe8 51 "Outlier value derived from imported data", add 
label define label_xispfe8 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe8 53 "Value not derived - data not usable", add 
...
label define label_xospro8 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro8 50 "Outlier value derived from reported data", add 
label define label_xospro8 51 "Outlier value derived from imported data", add 
label define label_xospro8 52 "Value not derived - parent/child differs across components", add 
label define label_xospro8 53 "Value not derived - data not usable", add 
...
label define label_xospfe8 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe8 50 "Outlier value derived from reported data", add 
label define label_xospfe8 51 "Outlier value derived from imported data", add 
label define label_xospfe8 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe8 53 "Value not derived - data not usable", add 
...
label define label_xispro9 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro9 50 "Outlier value derived from reported data", add 
label define label_xispro9 51 "Outlier value derived from imported data", add 
label define label_xispro9 52 "Value not derived - parent/child differs across components", add 
label define label_xispro9 53 "Value not derived - data not usable", add 
...
label define label_xispfe9 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe9 50 "Outlier value derived from reported data", add 
label define label_xispfe9 51 "Outlier value derived from imported data", add 
label define label_xispfe9 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe9 53 "Value not derived - data not usable", add 
...
label define label_xospro9 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro9 50 "Outlier value derived from reported data", add 
label define label_xospro9 51 "Outlier value derived from imported data", add 
label define label_xospro9 52 "Value not derived - parent/child differs across components", add 
label define label_xospro9 53 "Value not derived - data not usable", add 
...
label define label_xospfe9 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe9 50 "Outlier value derived from reported data", add 
label define label_xospfe9 51 "Outlier value derived from imported data", add 
label define label_xospfe9 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe9 53 "Value not derived - data not usable", add 
...
label define label_xispro10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro10 50 "Outlier value derived from reported data", add 
label define label_xispro10 51 "Outlier value derived from imported data", add 
label define label_xispro10 52 "Value not derived - parent/child differs across components", add 
label define label_xispro10 53 "Value not derived - data not usable", add 
...
label define label_xispfe10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe10 50 "Outlier value derived from reported data", add 
label define label_xispfe10 51 "Outlier value derived from imported data", add 
label define label_xispfe10 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe10 53 "Value not derived - data not usable", add 
...
label define label_xospro10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro10 50 "Outlier value derived from reported data", add 
label define label_xospro10 51 "Outlier value derived from imported data", add 
label define label_xospro10 52 "Value not derived - parent/child differs across components", add 
label define label_xospro10 53 "Value not derived - data not usable", add 
...
label define label_xospfe10 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe10 50 "Outlier value derived from reported data", add 
label define label_xospfe10 51 "Outlier value derived from imported data", add 
label define label_xospfe10 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe10 53 "Value not derived - data not usable", add 
...
label define label_xispro11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispro11 50 "Outlier value derived from reported data", add 
label define label_xispro11 51 "Outlier value derived from imported data", add 
label define label_xispro11 52 "Value not derived - parent/child differs across components", add 
label define label_xispro11 53 "Value not derived - data not usable", add 
...
label define label_xispfe11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xispfe11 50 "Outlier value derived from reported data", add 
label define label_xispfe11 51 "Outlier value derived from imported data", add 
label define label_xispfe11 52 "Value not derived - parent/child differs across components", add 
label define label_xispfe11 53 "Value not derived - data not usable", add 
...
label define label_xospro11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospro11 50 "Outlier value derived from reported data", add 
label define label_xospro11 51 "Outlier value derived from imported data", add 
label define label_xospro11 52 "Value not derived - parent/child differs across components", add 
label define label_xospro11 53 "Value not derived - data not usable", add 
...
label define label_xospfe11 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xospfe11 50 "Outlier value derived from reported data", add 
label define label_xospfe11 51 "Outlier value derived from imported data", add 
label define label_xospfe11 52 "Value not derived - parent/child differs across components", add 
label define label_xospfe11 53 "Value not derived - data not usable", add 
...
label define label_xchg1ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg1ay1 50 "Outlier value derived from reported data", add 
label define label_xchg1ay1 51 "Outlier value derived from imported data", add 
label define label_xchg1ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg1ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg1ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg1ay2 50 "Outlier value derived from reported data", add 
label define label_xchg1ay2 51 "Outlier value derived from imported data", add 
label define label_xchg1ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg1ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg1ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg1ay3 50 "Outlier value derived from reported data", add 
label define label_xchg1ay3 51 "Outlier value derived from imported data", add 
label define label_xchg1ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg1ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg2ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg2ay1 50 "Outlier value derived from reported data", add 
label define label_xchg2ay1 51 "Outlier value derived from imported data", add 
label define label_xchg2ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg2ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg2ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg2ay2 50 "Outlier value derived from reported data", add 
label define label_xchg2ay2 51 "Outlier value derived from imported data", add 
label define label_xchg2ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg2ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg2ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg2ay3 50 "Outlier value derived from reported data", add 
label define label_xchg2ay3 51 "Outlier value derived from imported data", add 
label define label_xchg2ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg2ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg3ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg3ay1 50 "Outlier value derived from reported data", add 
label define label_xchg3ay1 51 "Outlier value derived from imported data", add 
label define label_xchg3ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg3ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg3ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg3ay2 50 "Outlier value derived from reported data", add 
label define label_xchg3ay2 51 "Outlier value derived from imported data", add 
label define label_xchg3ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg3ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg3ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg3ay3 50 "Outlier value derived from reported data", add 
label define label_xchg3ay3 51 "Outlier value derived from imported data", add 
label define label_xchg3ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg3ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg4ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg4ay1 50 "Outlier value derived from reported data", add 
label define label_xchg4ay1 51 "Outlier value derived from imported data", add 
label define label_xchg4ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg4ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg4ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg4ay2 50 "Outlier value derived from reported data", add 
label define label_xchg4ay2 51 "Outlier value derived from imported data", add 
label define label_xchg4ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg4ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg4ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg4ay3 50 "Outlier value derived from reported data", add 
label define label_xchg4ay3 51 "Outlier value derived from imported data", add 
label define label_xchg4ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg4ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg5ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg5ay1 50 "Outlier value derived from reported data", add 
label define label_xchg5ay1 51 "Outlier value derived from imported data", add 
label define label_xchg5ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg5ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg5ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg5ay2 50 "Outlier value derived from reported data", add 
label define label_xchg5ay2 51 "Outlier value derived from imported data", add 
label define label_xchg5ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg5ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg5ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg5ay3 50 "Outlier value derived from reported data", add 
label define label_xchg5ay3 51 "Outlier value derived from imported data", add 
label define label_xchg5ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg5ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg6ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg6ay1 50 "Outlier value derived from reported data", add 
label define label_xchg6ay1 51 "Outlier value derived from imported data", add 
label define label_xchg6ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg6ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg6ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg6ay2 50 "Outlier value derived from reported data", add 
label define label_xchg6ay2 51 "Outlier value derived from imported data", add 
label define label_xchg6ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg6ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg6ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg6ay3 50 "Outlier value derived from reported data", add 
label define label_xchg6ay3 51 "Outlier value derived from imported data", add 
label define label_xchg6ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg6ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg7ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg7ay1 50 "Outlier value derived from reported data", add 
label define label_xchg7ay1 51 "Outlier value derived from imported data", add 
label define label_xchg7ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg7ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg7ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg7ay2 50 "Outlier value derived from reported data", add 
label define label_xchg7ay2 51 "Outlier value derived from imported data", add 
label define label_xchg7ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg7ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg7ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg7ay3 50 "Outlier value derived from reported data", add 
label define label_xchg7ay3 51 "Outlier value derived from imported data", add 
label define label_xchg7ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg7ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg8ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg8ay1 50 "Outlier value derived from reported data", add 
label define label_xchg8ay1 51 "Outlier value derived from imported data", add 
label define label_xchg8ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg8ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg8ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg8ay2 50 "Outlier value derived from reported data", add 
label define label_xchg8ay2 51 "Outlier value derived from imported data", add 
label define label_xchg8ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg8ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg8ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg8ay3 50 "Outlier value derived from reported data", add 
label define label_xchg8ay3 51 "Outlier value derived from imported data", add 
label define label_xchg8ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg8ay3 53 "Value not derived - data not usable", add 
...
label define label_xchg9ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg9ay1 50 "Outlier value derived from reported data", add 
label define label_xchg9ay1 51 "Outlier value derived from imported data", add 
label define label_xchg9ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xchg9ay1 53 "Value not derived - data not usable", add 
...
label define label_xchg9ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg9ay2 50 "Outlier value derived from reported data", add 
label define label_xchg9ay2 51 "Outlier value derived from imported data", add 
label define label_xchg9ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xchg9ay2 53 "Value not derived - data not usable", add 
...
label define label_xchg9ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xchg9ay3 50 "Outlier value derived from reported data", add 
label define label_xchg9ay3 51 "Outlier value derived from imported data", add 
label define label_xchg9ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xchg9ay3 53 "Value not derived - data not usable", add 
label values xchg9ay3 label_xchg9ay3
label define label_xcmp1ay1 10 "Reported" 
label define label_xcmp1ay1 11 "Analyst corrected reported value", add 
label define label_xcmp1ay1 12 "Data generated from other data values", add 
label define label_xcmp1ay1 13 "Implied zero", add 
label define label_xcmp1ay1 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp1ay1 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp1ay1 22 "Imputed using the Group Median procedure", add 
label define label_xcmp1ay1 23 "Logical imputation", add 
label define label_xcmp1ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp1ay1 30 "Not applicable", add 
label define label_xcmp1ay1 31 "Institution left item blank", add 
label define label_xcmp1ay1 32 "Do not know", add 
label define label_xcmp1ay1 33 "Particular 1st prof field not applicable", add 
label define label_xcmp1ay1 50 "Outlier value derived from reported data", add 
label define label_xcmp1ay1 51 "Outlier value derived from imported data", add 
label define label_xcmp1ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp1ay1 53 "Value not derived - data not usable", add 
label values xcmp1ay1 label_xcmp1ay1
label define label_xcmp1ay2 10 "Reported" 
label define label_xcmp1ay2 11 "Analyst corrected reported value", add 
label define label_xcmp1ay2 12 "Data generated from other data values", add 
label define label_xcmp1ay2 13 "Implied zero", add 
label define label_xcmp1ay2 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp1ay2 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp1ay2 22 "Imputed using the Group Median procedure", add 
label define label_xcmp1ay2 23 "Logical imputation", add 
label define label_xcmp1ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp1ay2 30 "Not applicable", add 
label define label_xcmp1ay2 31 "Institution left item blank", add 
label define label_xcmp1ay2 32 "Do not know", add 
label define label_xcmp1ay2 33 "Particular 1st prof field not applicable", add 
label define label_xcmp1ay2 50 "Outlier value derived from reported data", add 
label define label_xcmp1ay2 51 "Outlier value derived from imported data", add 
label define label_xcmp1ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp1ay2 53 "Value not derived - data not usable", add 
label values xcmp1ay2 label_xcmp1ay2
label define label_xcmp1ay3 10 "Reported" 
label define label_xcmp1ay3 11 "Analyst corrected reported value", add 
label define label_xcmp1ay3 12 "Data generated from other data values", add 
label define label_xcmp1ay3 13 "Implied zero", add 
label define label_xcmp1ay3 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp1ay3 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp1ay3 22 "Imputed using the Group Median procedure", add 
label define label_xcmp1ay3 23 "Logical imputation", add 
label define label_xcmp1ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp1ay3 30 "Not applicable", add 
label define label_xcmp1ay3 31 "Institution left item blank", add 
label define label_xcmp1ay3 32 "Do not know", add 
label define label_xcmp1ay3 33 "Particular 1st prof field not applicable", add 
label define label_xcmp1ay3 50 "Outlier value derived from reported data", add 
label define label_xcmp1ay3 51 "Outlier value derived from imported data", add 
label define label_xcmp1ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp1ay3 53 "Value not derived - data not usable", add 
label values xcmp1ay3 label_xcmp1ay3
label define label_xcmp2ay1 10 "Reported" 
label define label_xcmp2ay1 11 "Analyst corrected reported value", add 
label define label_xcmp2ay1 12 "Data generated from other data values", add 
label define label_xcmp2ay1 13 "Implied zero", add 
label define label_xcmp2ay1 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp2ay1 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp2ay1 22 "Imputed using the Group Median procedure", add 
label define label_xcmp2ay1 23 "Logical imputation", add 
label define label_xcmp2ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp2ay1 30 "Not applicable", add 
label define label_xcmp2ay1 31 "Institution left item blank", add 
label define label_xcmp2ay1 32 "Do not know", add 
label define label_xcmp2ay1 33 "Particular 1st prof field not applicable", add 
label define label_xcmp2ay1 50 "Outlier value derived from reported data", add 
label define label_xcmp2ay1 51 "Outlier value derived from imported data", add 
label define label_xcmp2ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp2ay1 53 "Value not derived - data not usable", add 
label values xcmp2ay1 label_xcmp2ay1
label define label_xcmp2ay2 10 "Reported" 
label define label_xcmp2ay2 11 "Analyst corrected reported value", add 
label define label_xcmp2ay2 12 "Data generated from other data values", add 
label define label_xcmp2ay2 13 "Implied zero", add 
label define label_xcmp2ay2 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp2ay2 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp2ay2 22 "Imputed using the Group Median procedure", add 
label define label_xcmp2ay2 23 "Logical imputation", add 
label define label_xcmp2ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp2ay2 30 "Not applicable", add 
label define label_xcmp2ay2 31 "Institution left item blank", add 
label define label_xcmp2ay2 32 "Do not know", add 
label define label_xcmp2ay2 33 "Particular 1st prof field not applicable", add 
label define label_xcmp2ay2 50 "Outlier value derived from reported data", add 
label define label_xcmp2ay2 51 "Outlier value derived from imported data", add 
label define label_xcmp2ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp2ay2 53 "Value not derived - data not usable", add 
label values xcmp2ay2 label_xcmp2ay2
label define label_xcmp2ay3 10 "Reported" 
label define label_xcmp2ay3 11 "Analyst corrected reported value", add 
label define label_xcmp2ay3 12 "Data generated from other data values", add 
label define label_xcmp2ay3 13 "Implied zero", add 
label define label_xcmp2ay3 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp2ay3 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp2ay3 22 "Imputed using the Group Median procedure", add 
label define label_xcmp2ay3 23 "Logical imputation", add 
label define label_xcmp2ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp2ay3 30 "Not applicable", add 
label define label_xcmp2ay3 31 "Institution left item blank", add 
label define label_xcmp2ay3 32 "Do not know", add 
label define label_xcmp2ay3 33 "Particular 1st prof field not applicable", add 
label define label_xcmp2ay3 50 "Outlier value derived from reported data", add 
label define label_xcmp2ay3 51 "Outlier value derived from imported data", add 
label define label_xcmp2ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp2ay3 53 "Value not derived - data not usable", add 
label values xcmp2ay3 label_xcmp2ay3
label define label_xcmp3ay1 10 "Reported" 
label define label_xcmp3ay1 11 "Analyst corrected reported value", add 
label define label_xcmp3ay1 12 "Data generated from other data values", add 
label define label_xcmp3ay1 13 "Implied zero", add 
label define label_xcmp3ay1 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp3ay1 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp3ay1 22 "Imputed using the Group Median procedure", add 
label define label_xcmp3ay1 23 "Logical imputation", add 
label define label_xcmp3ay1 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp3ay1 30 "Not applicable", add 
label define label_xcmp3ay1 31 "Institution left item blank", add 
label define label_xcmp3ay1 32 "Do not know", add 
label define label_xcmp3ay1 33 "Particular 1st prof field not applicable", add 
label define label_xcmp3ay1 50 "Outlier value derived from reported data", add 
label define label_xcmp3ay1 51 "Outlier value derived from imported data", add 
label define label_xcmp3ay1 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp3ay1 53 "Value not derived - data not usable", add 
label values xcmp3ay1 label_xcmp3ay1
label define label_xcmp3ay2 10 "Reported" 
label define label_xcmp3ay2 11 "Analyst corrected reported value", add 
label define label_xcmp3ay2 12 "Data generated from other data values", add 
label define label_xcmp3ay2 13 "Implied zero", add 
label define label_xcmp3ay2 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp3ay2 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp3ay2 22 "Imputed using the Group Median procedure", add 
label define label_xcmp3ay2 23 "Logical imputation", add 
label define label_xcmp3ay2 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp3ay2 30 "Not applicable", add 
label define label_xcmp3ay2 31 "Institution left item blank", add 
label define label_xcmp3ay2 32 "Do not know", add 
label define label_xcmp3ay2 33 "Particular 1st prof field not applicable", add 
label define label_xcmp3ay2 50 "Outlier value derived from reported data", add 
label define label_xcmp3ay2 51 "Outlier value derived from imported data", add 
label define label_xcmp3ay2 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp3ay2 53 "Value not derived - data not usable", add 
label values xcmp3ay2 label_xcmp3ay2
label define label_xcmp3ay3 10 "Reported" 
label define label_xcmp3ay3 11 "Analyst corrected reported value", add 
label define label_xcmp3ay3 12 "Data generated from other data values", add 
label define label_xcmp3ay3 13 "Implied zero", add 
label define label_xcmp3ay3 20 "Imputed using Carry Forward procedure", add 
label define label_xcmp3ay3 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xcmp3ay3 22 "Imputed using the Group Median procedure", add 
label define label_xcmp3ay3 23 "Logical imputation", add 
label define label_xcmp3ay3 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xcmp3ay3 30 "Not applicable", add 
label define label_xcmp3ay3 31 "Institution left item blank", add 
label define label_xcmp3ay3 32 "Do not know", add 
label define label_xcmp3ay3 33 "Particular 1st prof field not applicable", add 
label define label_xcmp3ay3 50 "Outlier value derived from reported data", add 
label define label_xcmp3ay3 51 "Outlier value derived from imported data", add 
label define label_xcmp3ay3 52 "Value not derived - parent/child differs across components", add 
label define label_xcmp3ay3 53 "Value not derived - data not usable", add 
label values xcmp3ay3 label_xcmp3ay3
*/
tab xtuit1
tab xfee1
tab xhrchg1
...
gen year=2007
save "$PATH\Academic Calendar\Data\tuition2007.dta", replace
