...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2013_is_data_stata.csv", comma clear
label data "dct_sal2013_is"
...
save "$PATH\Academic Calendar\Data\faculty2013.dta", replace
