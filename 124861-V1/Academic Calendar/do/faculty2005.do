...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal2005_is_data_stata.csv", comma clear
label data "dct_sal2005_a"
...
save "$PATH\Academic Calendar\Data\faculty2005.dta", replace
