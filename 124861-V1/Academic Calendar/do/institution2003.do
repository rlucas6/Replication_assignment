...
*   
clear                                                     
insheet using "$PATH\Academic Calendar\Data\ic2003_data_stata.csv", comma clear
label data "dct_ic2003"
...
label define label_appdate 1 "Fall 2001", add 
label define label_appdate 2 "Fall 2002", add 
...
label define label_satactdt 1 "Fall 2001", add 
label define label_satactdt 2 "Fall 2002", add 
...
gen year=2003
sort unitid
save "$PATH\Academic Calendar\Data\institution2003.dta", replace
