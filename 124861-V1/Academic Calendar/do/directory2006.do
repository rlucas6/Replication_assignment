...
*           
clear                                             
insheet using "$PATH\Academic Calendar\Data\hd2006_data_stata.csv", comma clear
...
gen year=2006
sort unitid
save "$PATH\Academic Calendar\Data\directory2006.dta", replace
