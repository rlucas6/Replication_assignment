...
insheet using f0203_f1a_data_stata.csv, comma clear
label data "dct_f0203_f1a"
...
label define label_xf1a01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a01 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a02 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a03 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a04 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a05 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a06 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a07 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a08 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a09 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a10 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a11 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a12 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a12 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a13 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a13 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a14 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a14 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a15 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a15 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a16 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a16 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a17 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a17 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a18 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a18 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a211 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a211 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a212 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a212 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a213 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a213 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a214 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a214 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a221 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a221 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a222 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a222 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a223 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a223 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a224 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a224 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a231 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a231 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a232 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a232 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a233 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a233 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a234 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a234 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a241 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a241 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a242 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a242 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a243 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a243 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a244 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a244 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a251 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a251 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a252 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a252 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a253 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a253 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a254 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a254 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a261 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a261 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a262 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a262 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a263 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a263 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a264 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a264 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a271 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a271 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a272 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a272 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a273 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a273 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a274 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a274 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a281 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a281 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a282 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a282 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a283 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a283 51 "Outlier value derived from imputed data", add 
...
label define label_xf1a284 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1a284 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b01 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b02 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b03 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b04 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b05 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b06 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b07 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b08 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b09 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b10 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b11 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b12 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b12 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b13 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b13 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b14 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b14 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b15 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b15 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b16 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b16 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b17 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b17 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b18 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b18 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b19 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b19 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b20 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b20 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b21 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b21 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b22 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b22 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b23 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b23 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b24 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b24 51 "Outlier value derived from imputed data", add 
...
label define label_xf1b25 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1b25 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c011 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c011 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c012 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c012 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c013 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c014 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c014 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c015 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c015 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c021 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c021 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c022 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c022 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c023 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c024 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c024 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c025 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c025 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c031 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c031 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c032 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c032 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c033 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c033 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c034 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c034 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c035 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c035 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c051 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c051 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c052 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c052 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c053 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c053 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c054 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c054 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c055 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c055 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c061 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c061 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c062 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c062 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c063 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c064 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c064 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c065 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c065 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c071 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c071 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c072 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c072 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c073 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c074 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c074 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c075 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c075 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c081 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c081 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c082 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c082 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c083 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c083 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c084 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c084 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c085 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c085 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c091 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c091 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c094 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c094 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c101 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c101 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c102 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c102 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c103 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c103 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c104 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c104 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c105 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c105 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c111 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c111 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c112 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c112 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c113 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c113 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c114 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c114 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c115 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c115 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c121 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c121 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c122 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c122 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c123 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c123 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c124 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c124 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c125 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c125 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c131 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c131 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c132 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c132 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c133 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c133 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c134 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c134 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c135 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c135 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c141 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c141 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c142 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c142 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c143 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c143 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c144 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c144 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c145 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c145 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c151 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c151 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c152 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c152 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c153 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c153 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c154 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c154 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c155 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c155 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c161 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c161 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c165 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c165 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c171 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c171 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c172 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c172 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c173 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c173 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c174 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c174 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c175 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c175 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c181 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c181 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c182 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c182 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c183 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c183 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c184 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c184 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c185 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c185 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c191 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c191 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c192 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c192 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c193 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c193 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c194 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c194 51 "Outlier value derived from imputed data", add 
...
label define label_xf1c195 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1c195 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d01 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d02 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d03 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d04 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d05 51 "Outlier value derived from imputed data", add 
...
label define label_xf1d06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1d06 51 "Outlier value derived from imputed data", add 
...
label define label_xf1h01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1h01 51 "Outlier value derived from imputed data", add 
...
label define label_xf1h02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1h02 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e01 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e02 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e03 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e04 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e05 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e06 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e07 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e08 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e09 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e10 51 "Outlier value derived from imputed data", add 
...
label define label_xf1e11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf1e11 51 "Outlier value derived from imputed data", add 
...
des
 ...
 save publicrevenues2003.dta, replace
