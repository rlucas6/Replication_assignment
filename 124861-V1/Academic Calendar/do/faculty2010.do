...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal2010_is_data_stata.csv", comma clear
label data "dct_sal2010_a"
...
label define label_arank 7 "All instructional staff total", add 
label values arank label_arank
*The following are values for the item imputation field variables
*'A' 'Not applicable'
...
save "$PATH\Academic Calendar\Data\faculty2010.dta", replace
