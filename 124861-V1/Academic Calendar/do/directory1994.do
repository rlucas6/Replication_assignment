...
*  
clear                                                      
insheet using "$PATH\Academic Calendar\Data\hd1994_data_stata.csv", comma clear
label data "dct_ic1994_a"
...
label variable formrt "Survey form IC1, IC2, IC3, IC4 or IC-Add"
...
label define label_carnegie 21 "Masters (comprehensive) universities and colleges I", add 
label define label_carnegie 22 "Masters (comprehensive) universities and colleges II", add 
label define label_carnegie 31 "Baccalaureate (liberal arts) colleges I", add 
...
label define label_carnegie 51 "Theological seminaries, Bible colleges and other institutions offering degrees in religion", add 
...
label define label_carnegie 57 "School of law", add 
...
label define label_ncesedit 1 "Data edited, no critical errors remain" 
label define label_ncesedit 2 "Data edited, anlyst corrected/accepted errors", add 
label define label_ncesedit 3 "Data edited, critical errors remain uncorrected", add 
...
gen year=1994
sort unitid
save "$PATH\Academic Calendar\Data\directory1994.dta", replace
