...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2017_is_data_stata.csv", comma clear
label data "dct_sal2017_is"
...
save "$PATH\Academic Calendar\Data\faculty2017.dta", replace
