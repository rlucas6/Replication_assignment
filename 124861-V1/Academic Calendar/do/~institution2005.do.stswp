...
*       
clear                                                 
insheet using "$PATH\Academic Calendar\Data\ic2005_data_stata.csv", comma clear
label data "dct_ic2005"
...
label define label_appdate 1 "Fall 2004", add 
label define label_appdate 2 "Fall 2005", add 
...
label define label_xapplcnm 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xapplcnw 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xadmssnm 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xadmssnw 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlftm 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlftw 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlptm 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlptw 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_satactdt 1 "Fall 2004", add 
label define label_satactdt 2 "Fall 2005", add 
...
label define label_xsatnum 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsatpct 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactnum 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactpct 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsatvr25 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsatvr75 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsatmt25 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xsatmt75 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactcm25 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactcm75 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xacten25 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xacten75 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactmt25 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xactmt75 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xappfeeu 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xappfeeg 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xappfeep 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xroomcap 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xmealswk 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xroomamt 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xbordamt 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xrmbdamt 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlm 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlw 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlt 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xapplcn 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xadmssn 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlft 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xenrlpt 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
gen year=2005
sort unitid
save "$PATH\Academic Calendar\Data\institution2005.dta", replace
