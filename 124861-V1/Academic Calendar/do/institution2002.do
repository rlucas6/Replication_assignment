...
*                         
clear                               
insheet using "$PATH\Academic Calendar\Data\ic2002_data_stata.csv", comma clear
label data "dct_ic2002"
...
label variable ptstu "Part time students are enrolled"
...
label define label_confno1 100 "Mountain West Conference" 
...
label define label_confno2 100 "Mountain West Conference" 
...
label define label_confno3 100 "Mountain West Conference" 
...
label define label_confno4 100 "Mountain West Conference" 
...
label define label_ptstu -1 "{Item not reported}" 
label define label_ptstu -2 "{Item not applicable}", add 
label define label_ptstu 1 "Yes", add 
label define label_ptstu 2 "No", add 
label values ptstu label_ptstu
...
label define label_xenrlm 23 "Partial imputation", add 
...
label define label_xenrlm 40 "Suppressed to protect confidentiality", add 
...
label define label_xenrlw 23 "Partial imputation", add 
...
label define label_xenrlw 40 "Suppressed to protect confidentiality", add 
...
label define label_xenrlt 23 "Partial imputation", add 
...
label define label_xenrlt 40 "Suppressed to protect confidentiality", add 
...
label define label_xapplcn 23 "Partial imputation", add 
...
label define label_xapplcn 40 "Suppressed to protect confidentiality", add 
...
label define label_xadmssn 23 "Partial imputation", add 
...
label define label_xadmssn 40 "Suppressed to protect confidentiality", add 
...
label define label_xenrlft 23 "Partial imputation", add 
...
label define label_xenrlft 40 "Suppressed to protect confidentiality", add 
...
label define label_xenrlpt 23 "Partial imputation", add 
...
label define label_xenrlpt 40 "Suppressed to protect confidentiality", add 
...
gen year=2002
sort unitid
save "$PATH\Academic Calendar\Data\institution2002.dta", replace
