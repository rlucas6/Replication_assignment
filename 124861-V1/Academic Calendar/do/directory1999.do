...
*              
clear                                          
insheet using "$PATH\Academic Calendar\Data\hd1999_data_stata.csv", comma clear
label data "dct_ic99_hd"
...
label define label_form_ic 15 "Institution added during current year", add 
...
label define label_countynm -1 "{Not reported}" 
label define label_countynm Alpha "{Alpha}", add
label values countynm label_countynm*/
...
/*label define label_date_ic -2 "{Item not applicable}" 
label define label_date_ic Alpha "{Alpha}", add 
label values date_ic label_date_ic*/
...
gen year=1999
sort unitid
save "$PATH\Academic Calendar\Data\directory1999.dta", replace
