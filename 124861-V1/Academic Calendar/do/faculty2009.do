...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2009_is_data_stata.csv", comma clear
label data "dct_sal2009_a_rv"
...
save "$PATH\Academic Calendar\Data\faculty2009.dta", replace
