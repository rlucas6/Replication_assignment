...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2008_is_data_stata.csv", comma clear
label data "dct_sal2008_a"
...
save "$PATH\Academic Calendar\Data\faculty2008.dta", replace
