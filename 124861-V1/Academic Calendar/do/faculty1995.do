...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal1995_is_data_stata.csv", comma clear
label data "dct_sal95_a_1"
...
save "$PATH\Academic Calendar\Data\faculty1995.dta", replace
