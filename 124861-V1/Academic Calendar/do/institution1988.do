...
* 
clear                                                       
insheet using "$PATH\Academic Calendar\Data\ic1988_data_stata.csv", comma clear
label data "dct_ic1988_a"
...
label define label_protaffl 90 "Young Mens Christian Association", add 
...
label define label_othaffl 39 "Evangelical Lutheran Church" 
...
label define label_othaffl 66 "Presbyterian Church (SUA)", add 
...
gen year=1988
sort unitid
save "$PATH\Academic Calendar\Data\institution1988.dta", replace
