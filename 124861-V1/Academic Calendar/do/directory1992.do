...
*                    
clear                                    
insheet using "$PATH\Academic Calendar\Data\hd1992_data_stata.csv", comma clear
label data "dct_ic1992_a"
...
label variable formrt "Survey form IC1, IC2, IC3, or IC-Add"
...
label variable postsec "Entity surveyed is a postsecondary institution"
...
label variable acc45 "Respiratory Therapist Technician"
...
label define label_control 0 "Not a valid response" 
...
label define label_postsec 1 "Yes" 
...
label define label_protaffl 80 "Jewish", add 
...
gen year=1992
sort unitid
save "$PATH\Academic Calendar\Data\directory1992.dta", replace
