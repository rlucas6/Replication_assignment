...
*        
clear                                                
insheet using "$PATH\Academic Calendar\Data\gr1997_data_stata.csv", comma clear
label data "dct_gr1997"
...
keep if grtype==2 | grtype==3 | grtype==13 | grtype==14
