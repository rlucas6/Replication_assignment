...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal1991_is_data_stata.csv", comma clear
label data "dct_sal1991_a"
...
save "$PATH\Academic Calendar\Data\faculty1991.dta", replace
