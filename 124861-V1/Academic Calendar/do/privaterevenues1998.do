...
insheet using f9798_f2_data_stata.csv, comma clear
label data "dct_f9798_f2"
...
label define label_xf2a01_1 20 "Imputed using data from prior year", add 
label define label_xf2a01_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a01_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a02_1 20 "Imputed using data from prior year", add 
label define label_xf2a02_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a02_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a04_1 20 "Imputed using data from prior year", add 
label define label_xf2a04_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a04_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a05_1 20 "Imputed using data from prior year", add 
label define label_xf2a05_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a05_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a06_1 20 "Imputed using data from prior year", add 
label define label_xf2a06_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a06_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a07_1 20 "Imputed using data from prior year", add 
label define label_xf2a07_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a07_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a08_1 20 "Imputed using data from prior year", add 
label define label_xf2a08_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a08_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a09_1 20 "Imputed using data from prior year", add 
label define label_xf2a09_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a09_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a10_1 20 "Imputed using data from prior year", add 
label define label_xf2a10_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a10_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a11_1 20 "Imputed using data from prior year", add 
label define label_xf2a11_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a11_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a12_1 20 "Imputed using data from prior year", add 
label define label_xf2a12_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a12_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a13_1 20 "Imputed using data from prior year", add 
label define label_xf2a13_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a13_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a14_1 20 "Imputed using data from prior year", add 
label define label_xf2a14_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a14_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a15_1 20 "Imputed using data from prior year", add 
label define label_xf2a15_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a15_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a16_1 20 "Imputed using data from prior year", add 
label define label_xf2a16_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a16_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2a17_1 20 "Imputed using data from prior year", add 
label define label_xf2a17_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2a17_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa01 20 "Imputed using data from prior year", add 
label define label_xf2aa01 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa01 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa02 20 "Imputed using data from prior year", add 
label define label_xf2aa02 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa02 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa03 20 "Imputed using data from prior year", add 
label define label_xf2aa03 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa03 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa04 20 "Imputed using data from prior year", add 
label define label_xf2aa04 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa04 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa05 20 "Imputed using data from prior year", add 
label define label_xf2aa05 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa05 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa06 20 "Imputed using data from prior year", add 
label define label_xf2aa06 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa06 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa07 20 "Imputed using data from prior year", add 
label define label_xf2aa07 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa07 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa08 20 "Imputed using data from prior year", add 
label define label_xf2aa08 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa08 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2aa09 20 "Imputed using data from prior year", add 
label define label_xf2aa09 21 "Imputed using method other than prior year data", add 
...
label define label_xf2aa09 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b01_1 20 "Imputed using data from prior year", add 
label define label_xf2b01_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b01_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b01_2 20 "Imputed using data from prior year", add 
label define label_xf2b01_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b01_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b02_1 20 "Imputed using data from prior year", add 
label define label_xf2b02_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b02_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b02_2 20 "Imputed using data from prior year", add 
label define label_xf2b02_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b02_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b03_1 20 "Imputed using data from prior year", add 
label define label_xf2b03_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b03_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b03_2 20 "Imputed using data from prior year", add 
label define label_xf2b03_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b03_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b04_1 20 "Imputed using data from prior year", add 
label define label_xf2b04_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b04_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b04_2 20 "Imputed using data from prior year", add 
label define label_xf2b04_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b04_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b05_1 20 "Imputed using data from prior year", add 
label define label_xf2b05_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b05_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b05_2 20 "Imputed using data from prior year", add 
label define label_xf2b05_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b05_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b06_1 20 "Imputed using data from prior year", add 
label define label_xf2b06_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b06_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b06_2 20 "Imputed using data from prior year", add 
label define label_xf2b06_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b06_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b07_1 20 "Imputed using data from prior year", add 
label define label_xf2b07_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b07_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b07_2 20 "Imputed using data from prior year", add 
label define label_xf2b07_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b07_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b08_1 20 "Imputed using data from prior year", add 
label define label_xf2b08_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b08_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b08_2 20 "Imputed using data from prior year", add 
label define label_xf2b08_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b08_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b09_1 20 "Imputed using data from prior year", add 
label define label_xf2b09_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b09_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b09_2 20 "Imputed using data from prior year", add 
label define label_xf2b09_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b09_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b10_1 20 "Imputed using data from prior year", add 
label define label_xf2b10_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b10_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b10_2 20 "Imputed using data from prior year", add 
label define label_xf2b10_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b10_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b11_2 20 "Imputed using data from prior year", add 
label define label_xf2b11_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b11_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_1 20 "Imputed using data from prior year", add 
label define label_xf2b12_1 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_1 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_2 20 "Imputed using data from prior year", add 
label define label_xf2b12_2 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_2 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_3 20 "Imputed using data from prior year", add 
label define label_xf2b12_3 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_3 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_5 20 "Imputed using data from prior year", add 
label define label_xf2b12_5 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_5 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_6 20 "Imputed using data from prior year", add 
label define label_xf2b12_6 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_6 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2b12_7 20 "Imputed using data from prior year", add 
label define label_xf2b12_7 21 "Imputed using method other than prior year data", add 
...
label define label_xf2b12_7 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c01 20 "Imputed using data from prior year", add 
label define label_xf2c01 21 "Imputed using method other than prior year data", add 
label define label_xf2c01 22 "Imputed using the Group Median procedure", add 
label define label_xf2c01 30 "Not applicable", add 
label define label_xf2c01 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c02 20 "Imputed using data from prior year", add 
label define label_xf2c02 21 "Imputed using method other than prior year data", add 
label define label_xf2c02 22 "Imputed using the Group Median procedure", add 
label define label_xf2c02 30 "Not applicable", add 
label define label_xf2c02 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c0308 20 "Imputed using data from prior year", add 
label define label_xf2c0308 21 "Imputed using method other than prior year data", add 
...
label define label_xf2c0308 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c09 20 "Imputed using data from prior year", add 
label define label_xf2c09 21 "Imputed using method other than prior year data", add 
label define label_xf2c09 22 "Imputed using the Group Median procedure", add 
label define label_xf2c09 30 "Not applicable", add 
label define label_xf2c09 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c10 20 "Imputed using data from prior year", add 
label define label_xf2c10 21 "Imputed using method other than prior year data", add 
label define label_xf2c10 22 "Imputed using the Group Median procedure", add 
label define label_xf2c10 30 "Not applicable", add 
label define label_xf2c10 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c11 20 "Imputed using data from prior year", add 
label define label_xf2c11 21 "Imputed using method other than prior year data", add 
label define label_xf2c11 22 "Imputed using the Group Median procedure", add 
label define label_xf2c11 30 "Not applicable", add 
label define label_xf2c11 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2c12 20 "Imputed using data from prior year", add 
label define label_xf2c12 21 "Imputed using method other than prior year data", add 
label define label_xf2c12 22 "Imputed using the Group Median procedure", add 
label define label_xf2c12 30 "Not applicable", add 
label define label_xf2c12 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d05 20 "Imputed using data from prior year", add 
label define label_xf2d05 21 "Imputed using method other than prior year data", add 
label define label_xf2d05 22 "Imputed using the Group Median procedure", add 
label define label_xf2d05 30 "Not applicable", add 
label define label_xf2d05 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d08 20 "Imputed using data from prior year", add 
label define label_xf2d08 21 "Imputed using method other than prior year data", add 
label define label_xf2d08 22 "Imputed using the Group Median procedure", add 
label define label_xf2d08 30 "Not applicable", add 
label define label_xf2d08 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d17 20 "Imputed using data from prior year", add 
label define label_xf2d17 21 "Imputed using method other than prior year data", add 
label define label_xf2d17 22 "Imputed using the Group Median procedure", add 
label define label_xf2d17 30 "Not applicable", add 
label define label_xf2d17 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d20 20 "Imputed using data from prior year", add 
label define label_xf2d20 21 "Imputed using method other than prior year data", add 
label define label_xf2d20 22 "Imputed using the Group Median procedure", add 
label define label_xf2d20 30 "Not applicable", add 
label define label_xf2d20 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d23 20 "Imputed using data from prior year", add 
label define label_xf2d23 21 "Imputed using method other than prior year data", add 
label define label_xf2d23 22 "Imputed using the Group Median procedure", add 
label define label_xf2d23 30 "Not applicable", add 
label define label_xf2d23 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2d24 20 "Imputed using data from prior year", add 
label define label_xf2d24 21 "Imputed using method other than prior year data", add 
label define label_xf2d24 22 "Imputed using the Group Median procedure", add 
label define label_xf2d24 30 "Not applicable", add 
label define label_xf2d24 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2dc014 20 "Imputed using data from prior year", add 
label define label_xf2dc014 21 "Imputed using method other than prior year data", add 
...
label define label_xf2dc014 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2dc024 20 "Imputed using data from prior year", add 
label define label_xf2dc024 21 "Imputed using method other than prior year data", add 
...
label define label_xf2dc024 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2dc034 20 "Imputed using data from prior year", add 
label define label_xf2dc034 21 "Imputed using method other than prior year data", add 
...
label define label_xf2dc034 31 "Imputed using Nearest Neighbor procedure", add 
...
label define label_xf2dc044 20 "Imputed using data from prior year", add 
label define label_xf2dc044 21 "Imputed using method other than prior year data", add 
...
label define label_xf2dc044 31 "Imputed using Nearest Neighbor procedure", add 
...
keep unitid f2c01 f2b12_1 
rename f2c01 revenue
rename f2b12_1 costs
gen year=1998
des
sum


 save privaterevenues1998.dta, replace
