...
insheet using f0304_f2_data_stata.csv, comma clear
label data "dct_f0304_f2"
...
label define label_xf2a01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a01 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a02 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a03 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a04 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a05 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a05a 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a05a 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a06 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a11 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a12 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a12 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a13 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a13 51 "Outlier value derived from imputed data", add 
...
label define label_xf2a14 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2a14 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b01 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b02 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b03 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b04 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b05 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b06 51 "Outlier value derived from imputed data", add 
...
label define label_xf2b07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2b07 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c01 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c02 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c03 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c04 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c05 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c06 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c07 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c08 51 "Outlier value derived from imputed data", add 
...
label define label_xf2c09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2c09 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d01 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d02 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d03 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d03 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d04 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d04 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d05 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d05 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d06 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d06 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d07 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d07 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d08 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d08 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d09 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d09 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d10 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d10 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d11 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d11 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d12 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d12 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d13 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d13 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d14 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d14 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d15 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d15 51 "Outlier value derived from imputed data", add 
...
label define label_xf2d16 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2d16 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e011 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e011 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e012 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e012 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e013 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e013 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e014 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e014 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e015 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e015 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e016 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e016 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e017 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e017 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e021 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e021 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e022 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e022 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e023 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e023 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e024 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e024 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e025 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e025 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e026 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e026 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e027 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e027 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e031 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e031 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e032 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e032 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e033 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e033 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e034 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e034 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e035 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e035 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e036 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e036 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e037 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e037 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e041 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e041 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e042 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e042 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e043 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e043 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e044 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e044 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e045 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e045 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e046 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e046 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e047 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e047 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e051 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e051 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e052 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e052 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e053 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e053 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e054 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e054 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e055 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e055 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e056 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e056 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e057 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e057 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e061 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e061 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e062 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e062 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e063 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e063 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e064 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e064 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e065 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e065 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e066 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e066 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e067 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e067 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e071 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e071 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e072 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e072 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e073 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e073 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e074 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e074 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e075 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e075 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e076 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e076 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e077 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e077 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e081 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e081 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e082 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e082 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e083 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e083 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e084 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e084 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e085 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e085 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e086 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e086 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e087 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e087 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e091 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e091 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e092 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e092 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e093 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e093 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e094 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e094 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e095 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e095 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e096 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e096 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e097 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e097 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e101 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e101 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e102 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e102 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e103 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e103 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e104 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e104 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e105 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e105 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e106 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e106 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e107 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e107 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e111 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e111 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e112 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e112 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e113 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e113 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e114 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e114 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e115 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e115 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e116 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e116 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e117 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e117 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e121 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e121 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e122 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e122 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e123 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e123 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e124 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e124 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e125 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e125 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e126 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e126 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e127 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e127 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e131 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e131 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e132 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e132 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e133 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e133 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e134 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e134 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e135 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e135 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e136 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e136 51 "Outlier value derived from imputed data", add 
...
label define label_xf2e137 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2e137 51 "Outlier value derived from imputed data", add 
...
label define label_xf2h01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2h01 51 "Outlier value derived from imputed data", add 
...
label define label_xf2h02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xf2h02 51 "Outlier value derived from imputed data", add 
...
keep unitid f2d16 f2e131
rename f2d16 revenue
rename f2e131 costs
gen year=2004
des
sum

 save privaterevenues2004.dta, replace
