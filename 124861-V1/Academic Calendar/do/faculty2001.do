...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal2001_is_data_stata.csv", comma clear
...
drop if arank!=15
collapse (sum) empcount, by(unitid)
keep unitid empcount
rename empcount faculty
gen year=2001

save "$PATH\Academic Calendar\Data\faculty2001.dta", replace
