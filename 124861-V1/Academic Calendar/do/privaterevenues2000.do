...
insheet using f9900f2_data_stata.csv, comma clear
label data "dct_f9900f2"
...
label variable xf2e111 "Imputation field for F2E111 - Other expenditures"
label variable f2e111 "Other expenditures"
label variable xf2e112 "Imputation field for F2E112 - Salaries and wages from other expenditures"
label variable f2e112 "Salaries and wages from other expenditures"
...
label define label_xf2a01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a11 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a12 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a13 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2a14 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2b07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c08 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2c09 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d01 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d02 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d03 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d04 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d05 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d06 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d07 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d08 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d09 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d10 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d11 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d12 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d13 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d14 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d15 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2d16 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e011 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e012 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e021 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e022 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e031 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e032 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e041 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e042 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e051 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e052 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e061 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e062 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e071 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e072 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e081 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e082 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e091 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e092 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e101 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e102 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e111 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e112 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e121 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e122 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e141 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e151 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e161 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
label define label_xf2e171 21 "Imputed using Group Median or Nearest Neighbor procedure", add 
...
sum
 ...
 save privaterevenues2000.dta, replace
