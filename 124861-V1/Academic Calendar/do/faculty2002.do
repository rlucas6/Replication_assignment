...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal2002_is_data_stata.csv", comma clear
label data "dct_sal2002_a"
...
label define label_xempcntm 23 "Partial imputation", add 
...
label define label_xoutlaym 23 "Partial imputation", add 
...
label define label_xavesalm 23 "Partial imputation", add 
...
label define label_xempcntw 23 "Partial imputation", add 
...
label define label_xoutlayw 23 "Partial imputation", add 
...
label define label_xavesalw 23 "Partial imputation", add 
...
label define label_xempcntt 23 "Partial imputation", add 
...
label define label_xoutlayt 23 "Partial imputation", add 
...
label define label_xavesalt 23 "Partial imputation", add 
...
save "$PATH\Academic Calendar\Data\faculty2002.dta", replace
