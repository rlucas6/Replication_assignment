...
*
clear
insheet using "$PATH\Academic Calendar\Data\sal2014_is_data_stata.csv", comma clear
label data "dct_sal2014_is"
...
save "$PATH\Academic Calendar\Data\faculty2014.dta", replace
