...
insheet using f1992_b_data_stata.csv, comma clear
label data "dct_f1992_b"
...
label variable b221 "Total unrestricted current funds expenditures and transfers"
label variable b222 "Total restricted current funds expenditures and transfers"
label variable b223 "Total current funds expenditures and transfers"
...
label variable xb221 "Imputation field for B221 - Total unrestricted current funds expenditures and transfers"
label variable xb222 "Imputation field for B222 - Total restricted current funds expenditures and transfers"
label variable xb223 "Imputation field for B223 - Total current funds expenditures and transfers"
...
label define label_xb011 98 "Not a valid code value", add 
...
label define label_xb012 98 "Not a valid code value", add 
...
label define label_xb013 98 "Not a valid code value", add 
...
label define label_xb014 98 "Not a valid code value", add 
...
label define label_xb021 98 "Not a valid code value", add 
...
label define label_xb022 98 "Not a valid code value", add 
...
label define label_xb023 98 "Not a valid code value", add 
...
label define label_xb024 98 "Not a valid code value", add 
...
label define label_xb031 98 "Not a valid code value", add 
...
label define label_xb032 98 "Not a valid code value", add 
...
label define label_xb033 98 "Not a valid code value", add 
...
label define label_xb034 98 "Not a valid code value", add 
...
label define label_xb041 98 "Not a valid code value", add 
...
label define label_xb042 98 "Not a valid code value", add 
...
label define label_xb043 98 "Not a valid code value", add 
...
label define label_xb044 98 "Not a valid code value", add 
...
label define label_xb061 98 "Not a valid code value", add 
...
label define label_xb062 98 "Not a valid code value", add 
...
label define label_xb063 98 "Not a valid code value", add 
...
label define label_xb064 98 "Not a valid code value", add 
...
label define label_xb071 98 "Not a valid code value", add 
...
label define label_xb072 98 "Not a valid code value", add 
...
label define label_xb073 98 "Not a valid code value", add 
...
label define label_xb074 98 "Not a valid code value", add 
...
label define label_xb081 98 "Not a valid code value", add 
...
label define label_xb082 98 "Not a valid code value", add 
...
label define label_xb083 98 "Not a valid code value", add 
...
label define label_xb084 98 "Not a valid code value", add 
...
label define label_xb091 98 "Not a valid code value", add 
...
label define label_xb092 98 "Not a valid code value", add 
...
label define label_xb093 98 "Not a valid code value", add 
...
label define label_xb101 98 "Not a valid code value", add 
...
label define label_xb102 98 "Not a valid code value", add 
...
label define label_xb103 98 "Not a valid code value", add 
...
label define label_xb111 98 "Not a valid code value", add 
...
label define label_xb112 98 "Not a valid code value", add 
...
label define label_xb113 98 "Not a valid code value", add 
...
label define label_xb121 98 "Not a valid code value", add 
...
label define label_xb122 98 "Not a valid code value", add 
...
label define label_xb123 98 "Not a valid code value", add 
...
label define label_xb131 98 "Not a valid code value", add 
...
label define label_xb132 98 "Not a valid code value", add 
...
label define label_xb133 98 "Not a valid code value", add 
...
label define label_xb161 98 "Not a valid code value", add 
...
label define label_xb162 98 "Not a valid code value", add 
...
label define label_xb163 98 "Not a valid code value", add 
...
label define label_xb191 98 "Not a valid code value", add 
...
label define label_xb192 98 "Not a valid code value", add 
...
label define label_xb193 98 "Not a valid code value", add 
...
label define label_xb221 98 "Not a valid code value", add 
...
label define label_xb222 98 "Not a valid code value", add 
...
label define label_xb223 98 "Not a valid code value", add 
...
label define label_xb234 98 "Not a valid code value", add 
...
label define label_xb244 98 "Not a valid code value", add 
...
label define label_xb254 98 "Not a valid code value", add 
...
label define label_xb264 98 "Not a valid code value", add 
...
label define label_xb274 98 "Not a valid code value", add 
...
label define label_xbline05 98 "Not a valid code value", add 
...
label define label_xbline14 98 "Not a valid code value", add 
...
label define label_xbline15 98 "Not a valid code value", add 
...
label define label_xbline17 98 "Not a valid code value", add 
...
label define label_xbline18 98 "Not a valid code value", add 
...
label define label_xbline20 98 "Not a valid code value", add 
...
label define label_xbline21 98 "Not a valid code value", add 
