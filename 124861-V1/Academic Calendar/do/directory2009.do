...
*                              
clear                          
insheet using "$PATH\Academic Calendar\Data\hd2009_data_stata.csv", comma clear
...
label define label_cbsa 10020 "Abbeville, LA", add 
...
label define label_cbsa 14600 "Bradenton-Sarasota-Venice, FL", add 
...
label define label_cbsa 17660 "Coeur dAlene, ID", add 
...
label define label_cbsa 19620 "Del Rio, TX", add 
...
label define label_cbsa 26780 "Hutchinson, MN", add 
...
label define label_csa 102 "Albany-Corvallis-Lebanon, OR", add 
...
label define label_countycd 1003 "Baldwin, AL", add 
...
label define label_countycd 13015 "Bartow, GA", add 
...
label define label_countycd 13097 "Douglas, GA", add 
...
label define label_countycd 13227 "Pickens, GA", add 
...
label define label_countycd 13295 "Walker, GA", add 
...
label define label_countycd 17173 "Shelby, IL", add 
...
label define label_countycd 18059 "Hancock, IN", add 
...
label define label_countycd 20021 "Cherokee, KS", add 
...
label define label_countycd 21053 "Clinton, KY", add 
...
label define label_countycd 21125 "Laurel, KY", add 
...
label define label_countycd 24033 "Prince Georges, MD", add 
label define label_countycd 24037 "St. Marys, MD", add 
label define label_countycd 24039 "Somerset, MD", add 
label define label_countycd 24041 "Talbot, MD", add 
...
label define label_countycd 26157 "Tuscola, MI", add 
...
label define label_countycd 27005 "Becker, MN", add 
...
label define label_countycd 27059 "Isanti, MN", add 
...
label define label_countycd 27085 "McLeod, MN", add 
...
label define label_countycd 27159 "Wadena, MN", add 
...
label define label_countycd 28127 "Simpson, MS", add 
...
label define label_countycd 39075 "Holmes, OH", add 
...
label define label_countycd 48465 "Val Verde, TX", add 
...
label define label_countycd 48499 "Wood, TX", add 
...
label define label_countycd 49041 "Sevier, UT", add 
...
label define label_countycd 5091 "Miller, AR", add 
...
label define label_countycd 51683 "Manassas city, VA", add 
...
label define label_countycd 54089 "Summers, WV", add 
...
label define label_countycd 78010 "St. Croix Island, VI", add 
...
label define label_countycd 8014 "Broomfield, CO", add 
...
label define label_cngdstcd -2 "Not applicable" 
label define label_cngdstcd 1000 "DE - District 00", add 
label define label_cngdstcd 101 "AL - District 01", add 
...
label define label_cngdstcd 6999 "MP - District 99", add 
...
label define label_dfrcgid -1 "Not reported - Nontitle IV institutiondid not respond to all components" 
label define label_dfrcgid -2 "Not applicable - institution is inactive", add 
...
label define label_dfrcgid 100 "Public, 2-year colleges, small size, southeastern states, rural locale/2", add 
label define label_dfrcgid 101 "Public, 2-year colleges, large size,  western states/1", add 
label define label_dfrcgid 102 "Public, 2-year colleges, large size,  western states/2", add 
label define label_dfrcgid 103 "Public, 2-year colleges, large size,  western states/3", add 
label define label_dfrcgid 104 "Public, 2-year colleges, large size,  western states/4", add 
label define label_dfrcgid 105 "Public, 2-year colleges, medium size, western states, city locale.", add 
label define label_dfrcgid 106 "Public, 2-year colleges, medium size, western states, suburban locale.", add 
label define label_dfrcgid 107 "Public, 2-year colleges, medium size, western states, town locale.", add 
label define label_dfrcgid 108 "Public, 2-year colleges, medium size, western states, rural locale.", add 
label define label_dfrcgid 109 "Public, 2-year colleges, small size, western states/1", add 
label define label_dfrcgid 11 "Public, program reporter, nondegree-granting.", add 
label define label_dfrcgid 110 "Public, 2-year colleges, small size, western states/2", add 
label define label_dfrcgid 111 "Associates--Private not-for-profit/1", add 
label define label_dfrcgid 112 "Associates--Private not-for-profit/2", add 
label define label_dfrcgid 113 "Associates--Private not-for-profit/3", add 
label define label_dfrcgid 114 "Associates--Private for-profit, in New England.", add 
label define label_dfrcgid 115 "Associates--Private for-profit, in the Mid-Atlantic region/1", add 
label define label_dfrcgid 116 "Associates--Private for-profit, in the Mid-Atlantic region/2", add 
label define label_dfrcgid 117 "Associates--Private for-profit, in the Mid-Atlantic region/3", add 
label define label_dfrcgid 118 "Associates--Private for-profit, in the Mid-Atlantic region/4", add 
label define label_dfrcgid 119 "Associates--Private for-profit, in the Great Lakes region/1", add 
label define label_dfrcgid 12 "Private not-for-profit, academic year reporter, nondegree-granting/1", add 
label define label_dfrcgid 120 "Associates--Private for-profit, in the Great Lakes region/2", add 
label define label_dfrcgid 121 "Associates--Private for-profit, in the Great Lakes region/3", add 
label define label_dfrcgid 122 "Associates--Private for-profit, in the Great Lakes region/4", add 
label define label_dfrcgid 123 "Associates--Private for-profit, in the Plains region.", add 
label define label_dfrcgid 124 "Associates--Private for-profit, in the southeastern region/1", add 
label define label_dfrcgid 125 "Associates--Private for-profit, in the southeastern region/2", add 
label define label_dfrcgid 126 "Associates--Private for-profit, in the southeastern region/3", add 
label define label_dfrcgid 127 "Associates--Private for-profit, in the southeastern region/4", add 
label define label_dfrcgid 128 "Associates--Private for-profit, in the southeastern region/5", add 
label define label_dfrcgid 129 "Associates--Private for-profit, in the southeastern region/6", add 
label define label_dfrcgid 13 "Private not-for-profit, academic year reporter, nondegree-granting/2", add 
label define label_dfrcgid 130 "Associates--Private for-profit, in the southwestern region/1", add 
label define label_dfrcgid 131 "Associates--Private for-profit, in the southwestern region/2", add 
label define label_dfrcgid 132 "Associates--Private for-profit, in the southwestern region/3", add 
label define label_dfrcgid 133 "Associates--Private for-profit, in the Rocky Mountain region.", add 
label define label_dfrcgid 134 "Associates--Private for-profit, in the Far Western region/1", add 
label define label_dfrcgid 135 "Associates--Private for-profit, in the Far Western region/2", add 
label define label_dfrcgid 136 "Associates--Private for-profit, in the Far Western region/3", add 
label define label_dfrcgid 137 "Associates--Public 4-year Primarily Associates/1", add 
label define label_dfrcgid 138 "Associates--Public 4-year Primarily Associates/2", add 
label define label_dfrcgid 139 "Associates--Private not-for-profit 4-year Primarily Associates.", add 
label define label_dfrcgid 14 "Private not-for-profit, academic year reporter, nondegree-granting/3", add 
label define label_dfrcgid 140 "Associates--Private for-profit 4-year Primarily Associates/1", add 
label define label_dfrcgid 141 "Associates--Private for-profit 4-year Primarily Associates/2", add 
label define label_dfrcgid 142 "Research Universities (very high research activity), public/1", add 
label define label_dfrcgid 143 "Research Universities (very high research activity), public/2", add 
label define label_dfrcgid 144 "Research Universities (very high research activity), private not-for-profit.", add 
label define label_dfrcgid 145 "Research Universities (high research activity), public/1", add 
label define label_dfrcgid 146 "Research Universities (high research activity), public/2", add 
label define label_dfrcgid 147 "Research Universities (high research activity), private not-for-profit.", add 
label define label_dfrcgid 148 "Doctoral/Research Universities, public.", add 
label define label_dfrcgid 149 "Doctoral/Research Universities, private not-for-profit.", add 
label define label_dfrcgid 15 "Private not-for-profit, program reporter, nondegree-granting, largest program-health", add 
label define label_dfrcgid 150 "Doctoral/Research Universities, private for-profit.", add 
label define label_dfrcgid 151 "Masters Colleges and Universities (larger programs), public/1", add 
label define label_dfrcgid 152 "Masters Colleges and Universities (larger programs), public/2", add 
label define label_dfrcgid 153 "Masters Colleges and Universities (larger programs), public/3", add 
label define label_dfrcgid 154 "Masters Colleges and Universities (larger programs), public/4", add 
label define label_dfrcgid 155 "Masters Colleges and Universities (larger programs), public/5", add 
label define label_dfrcgid 156 "Masters Colleges and Universities (larger programs), private not-for-profit/1", add 
label define label_dfrcgid 157 "Masters Colleges and Universities (larger programs), private not-for-profit/2", add 
label define label_dfrcgid 158 "Masters Colleges and Universities (larger programs), private not-for-profit/3", add 
label define label_dfrcgid 159 "Masters Colleges and Universities (larger programs), private not-for-profit/4", add 
label define label_dfrcgid 16 "Private not-for-profit, program reporter, nondegree-granting/1", add 
label define label_dfrcgid 160 "Masters Colleges and Universities (larger programs), private not-for-profit/5", add 
label define label_dfrcgid 161 "Masters Colleges and Universities (larger programs), private for-profit.", add 
label define label_dfrcgid 162 "Masters Colleges and Universities (medium programs), public/1", add 
label define label_dfrcgid 163 "Masters Colleges and Universities (medium programs), public/2", add 
label define label_dfrcgid 164 "Masters Colleges and Universities (medium programs), private not-for-profit/1", add 
label define label_dfrcgid 165 "Masters Colleges and Universities (medium programs), private not-for-profit/2", add 
label define label_dfrcgid 166 "Masters Colleges and Universities (medium programs), private not-for-profit/3", add 
label define label_dfrcgid 167 "Masters Colleges and Universities (medium programs), private for-profit.", add 
label define label_dfrcgid 168 "Masters Colleges and Universities (smaller programs), public.", add 
label define label_dfrcgid 169 "Masters Colleges and Universities (smaller programs), private not-for-profit/1", add 
label define label_dfrcgid 17 "Private not-for-profit, program reporter, nondegree-granting/2", add 
label define label_dfrcgid 170 "Masters Colleges and Universities (smaller programs), private not-for-profit/2", add 
label define label_dfrcgid 171 "Masters Colleges and Universities (smaller programs), private not-for-profit/3", add 
label define label_dfrcgid 172 "Masters Colleges and Universities (smaller programs), private for-profit.", add 
label define label_dfrcgid 173 "Baccalaureate Colleges--Arts & Sciences, public.", add 
label define label_dfrcgid 174 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/1", add 
label define label_dfrcgid 175 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/2", add 
label define label_dfrcgid 176 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/3", add 
label define label_dfrcgid 177 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/4", add 
label define label_dfrcgid 178 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/5", add 
label define label_dfrcgid 179 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/6", add 
label define label_dfrcgid 18 "Private for-profit, academic year reporter, nondegree-granting/1", add 
label define label_dfrcgid 180 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/7", add 
label define label_dfrcgid 181 "Baccalaureate Colleges--Arts & Sciences, private not-for-profit/8", add 
label define label_dfrcgid 182 "Baccalaureate Colleges--Diverse Fields, public/1", add 
label define label_dfrcgid 183 "Baccalaureate Colleges--Diverse Fields, public/2", add 
label define label_dfrcgid 184 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/1", add 
label define label_dfrcgid 185 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/2", add 
label define label_dfrcgid 186 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/3", add 
label define label_dfrcgid 187 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/4", add 
label define label_dfrcgid 188 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/5", add 
label define label_dfrcgid 189 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/6", add 
label define label_dfrcgid 19 "Private for-profit, academic year reporter, nondegree-granting/2", add 
label define label_dfrcgid 190 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/7", add 
label define label_dfrcgid 191 "Baccalaureate Colleges--Diverse Fields, private not-for-profit/8", add 
label define label_dfrcgid 192 "Baccalaureate/Associates Colleges, public.", add 
label define label_dfrcgid 193 "Baccalaureate/Associates Colleges, private not-for-profit.", add 
label define label_dfrcgid 194 "Baccalaureate/Associates Colleges, private for-profit/1", add 
label define label_dfrcgid 195 "Baccalaureate/Associates Colleges, private for-profit/2", add 
label define label_dfrcgid 196 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-bachelors degree, undergraduate degrees/certificates offered/1", add 
label define label_dfrcgid 197 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-bachelors degree, undergraduate degrees/certificates offered/2", add 
label define label_dfrcgid 198 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates offered/1", add 
label define label_dfrcgid 199 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates offered/2", add 
...
label define label_dfrcgid 200 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-postbaccalaureate, undergraduate degrees/certificates not offered", add 
label define label_dfrcgid 201 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-PhD., undergraduate degrees/certificates offered.", add 
label define label_dfrcgid 202 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-PhD., undergraduate degrees or certificates are not offered/1", add 
label define label_dfrcgid 203 "Theological seminaries, Bible colleges, and other faith-related institutions, highest level-PhD., undergraduate degrees or certificates are not offered/2", add 
label define label_dfrcgid 204 "Medical schools and medical centers, public", add 
label define label_dfrcgid 205 "Medical schools and medical centers, private not-for-profit", add 
label define label_dfrcgid 206 "Other health professions schools, highest level of offering-bachelors degree.", add 
label define label_dfrcgid 207 "Other health professions schools, highest level of offering-postbaccalaureate/1", add 
label define label_dfrcgid 208 "Other health professions schools, highest level of offering-postbaccalaureate/2", add 
label define label_dfrcgid 209 "Other health professions schools, highest level of offering-postbaccalaureate/3", add 
label define label_dfrcgid 21 "Private for-profit, academic year reporter, nondegree-granting/4", add 
label define label_dfrcgid 210 "Schools of engineering.", add 
label define label_dfrcgid 211 "Other technology-related schools/1", add 
label define label_dfrcgid 212 "Other technology-related schools/2", add 
label define label_dfrcgid 213 "Schools of business and management, private not-for-profit", add 
label define label_dfrcgid 214 "Schools of business and management, privatefor-profit", add 
label define label_dfrcgid 215 "Schools of art, music, and design, highest level of offering-bachelors degree/1", add 
label define label_dfrcgid 216 "Schools of art, music, and design, highest level of offering-bachelors degree/2", add 
label define label_dfrcgid 217 "Schools of art, music, and design, highest level of offering-postbaccalaureate/1", add 
label define label_dfrcgid 218 "Schools of art, music, and design, highest level of offering-postbaccalaureate/2", add 
label define label_dfrcgid 219 "Schools of law.", add 
label define label_dfrcgid 22 "Private for-profit, program reporter, nondegree-granting, largest program-cosmetology/1", add 
label define label_dfrcgid 220 "Other special-focus institutions.", add 
label define label_dfrcgid 221 "Tribal Colleges.", add 
label define label_dfrcgid 222 "Baccalaureate Colleges--Arts & Sciences or Diverse Fields, private for-profit.", add 
label define label_dfrcgid 223 "Private, for-profit, 4 year, degree-granting institution, no Carnegie classification, highest degree awarded-Masters/1", add 
label define label_dfrcgid 224 "Private, for-profit, 4 year, degree-granting institution, no Carnegie classification, highest degree awarded-Masters/2", add 
label define label_dfrcgid 225 "Private, for-profit, 4 year, degree-granting institution, no Carnegie classification, highest degree awarded-Bachelors/1", add 
label define label_dfrcgid 226 "Private, for-profit, 4 year, degree-granting institution, no Carnegie classification, highest degree awarded-Bachelors/2", add 
label define label_dfrcgid 227 "Private, for-profit, 4 year, degree-granting institution, no Carnegie classification, highest degree awarded-Bachelors/3", add 
label define label_dfrcgid 228 "Private, not-for-profit, 4 year, degree-granting institution, no Carnegie classification.", add 
label define label_dfrcgid 229 "Non-Title IV, private not-for-profit, degree-granting.", add 
label define label_dfrcgid 23 "Private for-profit, program reporter, nondegree-granting, largest program-cosmetology/2", add 
label define label_dfrcgid 230 "Non-Title IV, private for-profit, degree-granting.", add 
label define label_dfrcgid 231 "Non-Title IV, nondegree-granting.", add 
label define label_dfrcgid 232 "U.S. Military Academies", add 
label define label_dfrcgid 233 "Title IV not primarily postsecondary public nondegree-granting.", add 
label define label_dfrcgid 234 "Public, 2-year degree-granting in American Samoa, Virgin Islands", add 
label define label_dfrcgid 235 "Public, less than 4 year in Puerto Rico.", add 
label define label_dfrcgid 236 "Public, 4 year, degree-granting in Puerto Rico.", add 
label define label_dfrcgid 237 "Private not-for-profit, degree-granting in Puerto Rico.", add 
label define label_dfrcgid 238 "Private not-for-profit, nondegree-granting in Puerto Rico.", add 
label define label_dfrcgid 239 "Private for-profit, degree-granting in Puerto Rico.", add 
label define label_dfrcgid 24 "Private for-profit, program reporter, nondegree-granting, largest program-cosmetology/3", add 
label define label_dfrcgid 240 "Private for-profit, nondegree-granting in Puerto Rico/1", add 
label define label_dfrcgid 241 "Private for-profit, nondegree-granting in Puerto Rico/2", add 
...
label define label_dfrcgid 56 "Private for-profit, program reporter, nondegree-granting, largest program-cosmetology/35", add 
label define label_dfrcgid 57 "Private for-profit, program reporter, nondegree-granting, largest program-health/1", add 
label define label_dfrcgid 58 "Private for-profit, program reporter, nondegree-granting, largest program-health/2", add 
label define label_dfrcgid 59 "Private for-profit, program reporter, nondegree-granting, largest program-health/3", add 
label define label_dfrcgid 6 "Public, program reporter, nondegree-granting, largest program-health/2", add 
label define label_dfrcgid 60 "Private for-profit, program reporter, nondegree-granting, largest program-health/4", add 
label define label_dfrcgid 61 "Private for-profit, program reporter, nondegree-granting, largest program-health/5", add 
label define label_dfrcgid 62 "Private for-profit, program reporter, nondegree-granting, largest program-health/6", add 
label define label_dfrcgid 63 "Private for-profit, program reporter, nondegree-granting, largest program-health/7", add 
label define label_dfrcgid 64 "Private for-profit, program reporter, nondegree-granting, largest program-health/8", add 
label define label_dfrcgid 65 "Private for-profit, program reporter, nondegree-granting, largest program-health/9", add 
label define label_dfrcgid 66 "Private for-profit, program reporter, nondegree-granting, largest program-health/10", add 
label define label_dfrcgid 67 "Private for-profit, program reporter, nondegree-granting, largest program-health/11", add 
label define label_dfrcgid 68 "Private for-profit, program reporter, nondegree-granting, largest program-health/12", add 
label define label_dfrcgid 69 "Private for-profit, program reporter, nondegree-granting, largest program-health/13", add 
label define label_dfrcgid 7 "Public, program reporter, nondegree-granting, largest program-health/3", add 
label define label_dfrcgid 70 "Private for-profit, program reporter, nondegree-granting/1", add 
label define label_dfrcgid 71 "Private for-profit, program reporter, nondegree-granting/2", add 
label define label_dfrcgid 72 "Private for-profit, program reporter, nondegree-granting/3", add 
label define label_dfrcgid 73 "Private for-profit, program reporter, nondegree-granting/4", add 
label define label_dfrcgid 74 "Private for-profit, program reporter, nondegree-granting/5", add 
label define label_dfrcgid 75 "Public, 2-year colleges, large size,  eastern states", add 
label define label_dfrcgid 76 "Public, 2-year colleges, medium size, eastern states, city locale.", add 
label define label_dfrcgid 77 "Public, 2-year colleges, medium size, eastern states, suburban locale.", add 
label define label_dfrcgid 78 "Public, 2-year colleges, medium size, eastern states, town locale.", add 
label define label_dfrcgid 79 "Public, 2-year colleges, medium size, eastern states, rural locale.", add 
label define label_dfrcgid 8 "Public, program reporter, nondegree-granting, largest program-health/4", add 
label define label_dfrcgid 80 "Public, 2-year colleges, small size, eastern states.", add 
label define label_dfrcgid 81 "Public, 2-year colleges, large size,  midwestern states/1", add 
label define label_dfrcgid 82 "Public, 2-year colleges, large size,  midwestern states/2", add 
label define label_dfrcgid 83 "Public, 2-year colleges, medium size, midwestern states, city locale.", add 
label define label_dfrcgid 84 "Public, 2-year colleges, medium size, midwestern states, suburban locale.", add 
label define label_dfrcgid 85 "Public, 2-year colleges, medium size, midwestern states, town locale.", add 
label define label_dfrcgid 86 "Public, 2-year colleges, medium size,  midwestern states, rural locale/1", add 
label define label_dfrcgid 87 "Public, 2-year colleges, medium size,  midwestern states, rural locale/2", add 
label define label_dfrcgid 88 "Public, 2-year colleges, small size, midwestern states/1", add 
label define label_dfrcgid 89 "Public, 2-year colleges, small size, midwestern states/2", add 
label define label_dfrcgid 9 "Public, program reporter, nondegree-granting, largest program-health/5", add 
label define label_dfrcgid 90 "Public, 2-year colleges, large size, southeastern states", add 
label define label_dfrcgid 902 "Minimum comparison group requirement - public 4-year degree-granting (Guam, Northern Marianas and Virgin Islands", add 
label define label_dfrcgid 904 "Minimum comparison group requirement -private <2-year in Guam", add 
label define label_dfrcgid 905 "Minimum comparison group requirement - non-Title IV, public 2-year, degree-granting", add 
label define label_dfrcgid 908 "Minimun comparison group requirement - Not primarily postsecondary private-not-for-profit institution", add 
label define label_dfrcgid 909 "Minimum comparison group requirement - Institution no open to the public", add 
label define label_dfrcgid 91 "Public, 2-year colleges, medium size, southeastern states, city locale.", add 
label define label_dfrcgid 92 "Public, 2-year colleges, medium size, southeastern states, suburban locale.", add 
label define label_dfrcgid 93 "Public, 2-year colleges, medium size, southeastern states, town locale.", add 
label define label_dfrcgid 94 "Public, 2-year colleges, medium size, southeastern states, rural locale/1", add 
label define label_dfrcgid 95 "Public, 2-year colleges, medium size, southeastern states, rural locale/2", add 
label define label_dfrcgid 96 "Public, 2-year colleges, small size, southeastern states, city locale.", add 
label define label_dfrcgid 97 "Public, 2-year colleges, small size, southeastern states, suburban locale.", add 
label define label_dfrcgid 98 "Public, 2-year colleges, small size, southeastern states, town locale.", add 
label define label_dfrcgid 99 "Public, 2-year colleges, small size, southeastern states, rural locale/1", add 
...
gen year=2009
sort unitid
save "$PATH\Academic Calendar\Data\directory2009.dta", replace
