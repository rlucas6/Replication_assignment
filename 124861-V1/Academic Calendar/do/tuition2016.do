...
*
insheet using "$PATH\Academic Calendar\Data\ic2016_ay_data_stata.csv", comma clear
label data "dct_ef2015d"
...
label variable xchg1at3 "Imputation field for chg1at3 - Published in-district tuition2016-17"
label variable chg1at3  "Published in-district tuition2016-17"
label variable xchg1af3 "Imputation field for chg1af3 - Published in-district fees 2016-17"
label variable chg1af3  "Published in-district fees 2016-17"
label variable xchg1ay3 "Imputation field for chg1ay3 - Published in-district tuition and fees 2016-17"
label variable chg1ay3  "Published in-district tuition and fees 2016-17"
label variable chg1tgtd "Published in-district tuition 2016-17 guaranteed percent increase (if applicable)"
label variable chg1fgtd "Published in-district fees 2016-17 guaranteed percent increase (if applicable)"
...
label variable xchg2at3 "Imputation field for chg2at3 - Published in-state tuition 2016-17"
label variable chg2at3  "Published in-state tuition 2016-17"
label variable xchg2af3 "Imputation field for chg2af3 - Published in-state fees 2016-17"
label variable chg2af3  "Published in-state fees 2016-17"
label variable xchg2ay3 "Imputation field for chg2ay3 - Published in-state tuition and fees 2016-17"
label variable chg2ay3  "Published in-state tuition and fees 2016-17"
label variable chg2tgtd "Published in-state tuition 2016-17 guaranteed percent increase (if applicable)"
label variable chg2fgtd "Published in-state fees 2016-17 guaranteed percent increase (if applicable)"
...
label variable xchg3at3 "Imputation field for chg3at3 - Published out-of-state tuition 2016-17"
label variable chg3at3  "Published out-of-state tuition 2016-17"
label variable xchg3af3 "Imputation field for chg3af3 - Published out-of-state fees 2016-17"
label variable chg3af3  "Published out-of-state fees 2016-17"
label variable xchg3ay3 "Imputation field for chg3ay3 - Published out-of-state tuition and fees 2016-17"
label variable chg3ay3  "Published out-of-state tuition and fees 2016-17"
label variable chg3tgtd "Published out-of-state tuition 2016-17 guaranteed percent increase (if applicable)"
label variable chg3fgtd "Published out-of-state fees 2016-17 guaranteed percent increase (if applicable)"
...
label variable xchg4ay3 "Imputation field for chg4ay3 - Books and supplies 2016-17"
label variable chg4ay3  "Books and supplies 2016-17"
...
label variable xchg5ay3 "Imputation field for chg5ay3 - On campus, room and board 2016-17"
label variable chg5ay3  "On campus, room and board 2016-17"
...
label variable xchg6ay3 "Imputation field for chg6ay3 - On campus, other expenses 2016-17"
label variable chg6ay3  "On campus, other expenses 2016-17"
...
label variable xchg7ay3 "Imputation field for chg7ay3 - Off campus (not with family), room and board 2016-17"
label variable chg7ay3  "Off campus (not with family), room and board 2016-17"
...
label variable xchg8ay3 "Imputation field for chg8ay3 - Off campus (not with family), other expenses 2016-17"
label variable chg8ay3  "Off campus (not with family), other expenses 2016-17"
...
label variable xchg9ay3 "Imputation field for chg9ay3 - Off campus (with family), other expenses 2016-17"
label variable chg9ay3  "Off campus (with family), other expenses 2016-17"
...
gen year=2016
save "$PATH\Academic Calendar\Data\tuition2016.dta", replace
