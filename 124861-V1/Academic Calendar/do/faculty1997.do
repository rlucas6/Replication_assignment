...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal1997_is_data_stata.csv", comma clear
label data "dct_sal97_a"
...
save "$PATH\Academic Calendar\Data\faculty1997.dta", replace
