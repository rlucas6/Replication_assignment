...
*                                                        
clear
insheet using "$PATH\Academic Calendar\Data\sal1993_is_data_stata.csv", comma clear
label data "dct_sal1993_a"
...
save "$PATH\Academic Calendar\Data\faculty1993.dta", replace
