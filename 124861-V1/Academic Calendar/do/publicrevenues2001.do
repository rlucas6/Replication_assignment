...
insheet using f0001_f1_data_stata.csv, comma clear
label data "dct_f0001_f1"
...
label variable xa113 "Imputation field for A113 - Sales and services of educational activities"
label variable a113 "Sales and services of educational activities"
...
label variable xj013 "Imputation field for J013 - Federal revenues"
label variable j013 "Federal revenues"
label variable xj023 "Imputation field for J023 - State revenues"
label variable j023 "State revenues"
label variable xj033 "Imputation field for J033 - Local revenues"
label variable j033 "Local revenues"
label variable xj043 "Imputation field for J043 - Sales and services"
label variable j043 "Sales and services"
label variable xj053 "Imputation field for J053 - Gifts, grants, contracts"
label variable j053 "Gifts, grants, contracts"
label variable xj063 "Imputation field for J063 - Endowment income"
label variable j063 "Endowment income"
label variable xj073 "Imputation field for J073 - Other sources"
label variable j073 "Other sources"
label variable xj083 "Imputation field for J083 - Total  revenues"
label variable j083 "Total  revenues"
...
label define label_xa013 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa013 22 "Imputed using the Group Median procedure", add 
label define label_xa013 23 "Partial imputation", add 
...
label define label_xa013 33 "Particular 1st prof field not applicable", add 
...
label define label_xa023 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa023 22 "Imputed using the Group Median procedure", add 
label define label_xa023 23 "Partial imputation", add 
...
label define label_xa023 33 "Particular 1st prof field not applicable", add 
...
label define label_xa043 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa043 22 "Imputed using the Group Median procedure", add 
label define label_xa043 23 "Partial imputation", add 
...
label define label_xa043 33 "Particular 1st prof field not applicable", add 
...
label define label_xa053 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa053 22 "Imputed using the Group Median procedure", add 
label define label_xa053 23 "Partial imputation", add 
...
label define label_xa053 33 "Particular 1st prof field not applicable", add 
...
label define label_xa063 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa063 22 "Imputed using the Group Median procedure", add 
label define label_xa063 23 "Partial imputation", add 
...
label define label_xa063 33 "Particular 1st prof field not applicable", add 
...
label define label_xa073 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa073 22 "Imputed using the Group Median procedure", add 
label define label_xa073 23 "Partial imputation", add 
...
label define label_xa073 33 "Particular 1st prof field not applicable", add 
...
label define label_xa083 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa083 22 "Imputed using the Group Median procedure", add 
label define label_xa083 23 "Partial imputation", add 
...
label define label_xa083 33 "Particular 1st prof field not applicable", add 
...
label define label_xa093 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa093 22 "Imputed using the Group Median procedure", add 
label define label_xa093 23 "Partial imputation", add 
...
label define label_xa093 33 "Particular 1st prof field not applicable", add 
...
label define label_xa103 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa103 22 "Imputed using the Group Median procedure", add 
label define label_xa103 23 "Partial imputation", add 
...
label define label_xa103 33 "Particular 1st prof field not applicable", add 
...
label define label_xa113 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa113 22 "Imputed using the Group Median procedure", add 
label define label_xa113 23 "Partial imputation", add 
...
label define label_xa113 33 "Particular 1st prof field not applicable", add 
...
label define label_xa123 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa123 22 "Imputed using the Group Median procedure", add 
label define label_xa123 23 "Partial imputation", add 
...
label define label_xa123 33 "Particular 1st prof field not applicable", add 
...
label define label_xa133 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa133 22 "Imputed using the Group Median procedure", add 
label define label_xa133 23 "Partial imputation", add 
...
label define label_xa133 33 "Particular 1st prof field not applicable", add 
...
label define label_xa143 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa143 22 "Imputed using the Group Median procedure", add 
label define label_xa143 23 "Partial imputation", add 
...
label define label_xa143 33 "Particular 1st prof field not applicable", add 
...
label define label_xa153 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa153 22 "Imputed using the Group Median procedure", add 
label define label_xa153 23 "Partial imputation", add 
...
label define label_xa153 33 "Particular 1st prof field not applicable", add 
...
label define label_xa163 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xa163 22 "Imputed using the Group Median procedure", add 
label define label_xa163 23 "Partial imputation", add 
...
label define label_xa163 33 "Particular 1st prof field not applicable", add 
...
label define label_xj013 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj013 22 "Imputed using the Group Median procedure", add 
label define label_xj013 23 "Partial imputation", add 
...
label define label_xj013 33 "Particular 1st prof field not applicable", add 
...
label define label_xj023 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj023 22 "Imputed using the Group Median procedure", add 
label define label_xj023 23 "Partial imputation", add 
...
label define label_xj023 33 "Particular 1st prof field not applicable", add 
...
label define label_xj033 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj033 22 "Imputed using the Group Median procedure", add 
label define label_xj033 23 "Partial imputation", add 
...
label define label_xj033 33 "Particular 1st prof field not applicable", add 
...
label define label_xj043 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj043 22 "Imputed using the Group Median procedure", add 
label define label_xj043 23 "Partial imputation", add 
...
label define label_xj043 33 "Particular 1st prof field not applicable", add 
...
label define label_xj053 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj053 22 "Imputed using the Group Median procedure", add 
label define label_xj053 23 "Partial imputation", add 
...
label define label_xj053 33 "Particular 1st prof field not applicable", add 
...
label define label_xj063 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj063 22 "Imputed using the Group Median procedure", add 
label define label_xj063 23 "Partial imputation", add 
...
label define label_xj063 33 "Particular 1st prof field not applicable", add 
...
label define label_xj073 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj073 22 "Imputed using the Group Median procedure", add 
label define label_xj073 23 "Partial imputation", add 
...
label define label_xj073 33 "Particular 1st prof field not applicable", add 
...
label define label_xj083 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xj083 22 "Imputed using the Group Median procedure", add 
label define label_xj083 23 "Partial imputation", add 
...
label define label_xj083 33 "Particular 1st prof field not applicable", add 
...
label define label_xb013 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb013 22 "Imputed using the Group Median procedure", add 
label define label_xb013 23 "Partial imputation", add 
...
label define label_xb013 33 "Particular 1st prof field not applicable", add 
...
label define label_xb023 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb023 22 "Imputed using the Group Median procedure", add 
label define label_xb023 23 "Partial imputation", add 
...
label define label_xb023 33 "Particular 1st prof field not applicable", add 
...
label define label_xb033 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb033 22 "Imputed using the Group Median procedure", add 
label define label_xb033 23 "Partial imputation", add 
...
label define label_xb033 33 "Particular 1st prof field not applicable", add 
...
label define label_xb043 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb043 22 "Imputed using the Group Median procedure", add 
label define label_xb043 23 "Partial imputation", add 
...
label define label_xb043 33 "Particular 1st prof field not applicable", add 
...
label define label_xb063 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb063 22 "Imputed using the Group Median procedure", add 
label define label_xb063 23 "Partial imputation", add 
...
label define label_xb063 33 "Particular 1st prof field not applicable", add 
...
label define label_xb073 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb073 22 "Imputed using the Group Median procedure", add 
label define label_xb073 23 "Partial imputation", add 
...
label define label_xb073 33 "Particular 1st prof field not applicable", add 
...
label define label_xb083 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb083 22 "Imputed using the Group Median procedure", add 
label define label_xb083 23 "Partial imputation", add 
...
label define label_xb083 33 "Particular 1st prof field not applicable", add 
...
label define label_xb093 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb093 22 "Imputed using the Group Median procedure", add 
label define label_xb093 23 "Partial imputation", add 
...
label define label_xb093 33 "Particular 1st prof field not applicable", add 
...
label define label_xb103 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb103 22 "Imputed using the Group Median procedure", add 
label define label_xb103 23 "Partial imputation", add 
...
label define label_xb103 33 "Particular 1st prof field not applicable", add 
...
label define label_xb113 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb113 22 "Imputed using the Group Median procedure", add 
label define label_xb113 23 "Partial imputation", add 
...
label define label_xb113 33 "Particular 1st prof field not applicable", add 
...
label define label_xb123 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb123 22 "Imputed using the Group Median procedure", add 
label define label_xb123 23 "Partial imputation", add 
...
label define label_xb123 33 "Particular 1st prof field not applicable", add 
...
label define label_xb133 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb133 22 "Imputed using the Group Median procedure", add 
label define label_xb133 23 "Partial imputation", add 
...
label define label_xb133 33 "Particular 1st prof field not applicable", add 
...
label define label_xbline15 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xbline15 22 "Imputed using the Group Median procedure", add 
label define label_xbline15 23 "Partial imputation", add 
...
label define label_xbline15 33 "Particular 1st prof field not applicable", add 
...
label define label_xb163 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb163 22 "Imputed using the Group Median procedure", add 
label define label_xb163 23 "Partial imputation", add 
...
label define label_xb163 33 "Particular 1st prof field not applicable", add 
...
label define label_xbline18 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xbline18 22 "Imputed using the Group Median procedure", add 
label define label_xbline18 23 "Partial imputation", add 
...
label define label_xbline18 33 "Particular 1st prof field not applicable", add 
...
label define label_xb193 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb193 22 "Imputed using the Group Median procedure", add 
label define label_xb193 23 "Partial imputation", add 
...
label define label_xb193 33 "Particular 1st prof field not applicable", add 
...
label define label_xbline21 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xbline21 22 "Imputed using the Group Median procedure", add 
label define label_xbline21 23 "Partial imputation", add 
...
label define label_xbline21 33 "Particular 1st prof field not applicable", add 
...
label define label_xbother 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xbother 22 "Imputed using the Group Median procedure", add 
label define label_xbother 23 "Partial imputation", add 
...
label define label_xbother 33 "Particular 1st prof field not applicable", add 
...
label define label_xb223 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb223 22 "Imputed using the Group Median procedure", add 
label define label_xb223 23 "Partial imputation", add 
...
label define label_xb223 33 "Particular 1st prof field not applicable", add 
...
label define label_xb234 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb234 22 "Imputed using the Group Median procedure", add 
label define label_xb234 23 "Partial imputation", add 
...
label define label_xb234 33 "Particular 1st prof field not applicable", add 
...
label define label_xb244 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb244 22 "Imputed using the Group Median procedure", add 
label define label_xb244 23 "Partial imputation", add 
...
label define label_xb244 33 "Particular 1st prof field not applicable", add 
...
label define label_xb254 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb254 22 "Imputed using the Group Median procedure", add 
label define label_xb254 23 "Partial imputation", add 
...
label define label_xb254 33 "Particular 1st prof field not applicable", add 
...
label define label_xb274 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xb274 22 "Imputed using the Group Median procedure", add 
label define label_xb274 23 "Partial imputation", add 
...
label define label_xb274 33 "Particular 1st prof field not applicable", add 
...
label define label_xe013 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe013 22 "Imputed using the Group Median procedure", add 
label define label_xe013 23 "Partial imputation", add 
...
label define label_xe013 33 "Particular 1st prof field not applicable", add 
...
label define label_xe023 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe023 22 "Imputed using the Group Median procedure", add 
label define label_xe023 23 "Partial imputation", add 
...
label define label_xe023 33 "Particular 1st prof field not applicable", add 
...
label define label_xe033 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe033 22 "Imputed using the Group Median procedure", add 
label define label_xe033 23 "Partial imputation", add 
...
label define label_xe033 33 "Particular 1st prof field not applicable", add 
...
label define label_xe043 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe043 22 "Imputed using the Group Median procedure", add 
label define label_xe043 23 "Partial imputation", add 
...
label define label_xe043 33 "Particular 1st prof field not applicable", add 
...
label define label_xe053 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe053 22 "Imputed using the Group Median procedure", add 
label define label_xe053 23 "Partial imputation", add 
...
label define label_xe053 33 "Particular 1st prof field not applicable", add 
...
label define label_xe063 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe063 22 "Imputed using the Group Median procedure", add 
label define label_xe063 23 "Partial imputation", add 
...
label define label_xe063 33 "Particular 1st prof field not applicable", add 
...
label define label_xe073 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xe073 22 "Imputed using the Group Median procedure", add 
label define label_xe073 23 "Partial imputation", add 
...
label define label_xe073 33 "Particular 1st prof field not applicable", add 
...
label define label_xg01 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xg01 22 "Imputed using the Group Median procedure", add 
label define label_xg01 23 "Partial imputation", add 
...
label define label_xg01 33 "Particular 1st prof field not applicable", add 
...
label define label_xg02 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xg02 22 "Imputed using the Group Median procedure", add 
label define label_xg02 23 "Partial imputation", add 
...
label define label_xg02 33 "Particular 1st prof field not applicable", add 
...
label define label_xg03 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xg03 22 "Imputed using the Group Median procedure", add 
label define label_xg03 23 "Partial imputation", add 
...
label define label_xg03 33 "Particular 1st prof field not applicable", add 
...
label define label_xg04 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xg04 22 "Imputed using the Group Median procedure", add 
label define label_xg04 23 "Partial imputation", add 
...
label define label_xg04 33 "Particular 1st prof field not applicable", add 
...
label define label_xg05 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xg05 22 "Imputed using the Group Median procedure", add 
label define label_xg05 23 "Partial imputation", add 
...
label define label_xg05 33 "Particular 1st prof field not applicable", add 
...
label define label_xh011 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xh011 22 "Imputed using the Group Median procedure", add 
label define label_xh011 23 "Partial imputation", add 
...
label define label_xh011 33 "Particular 1st prof field not applicable", add 
...
label define label_xh012 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xh012 22 "Imputed using the Group Median procedure", add 
label define label_xh012 23 "Partial imputation", add 
...
label define label_xh012 33 "Particular 1st prof field not applicable", add 
...
label define label_xh021 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xh021 22 "Imputed using the Group Median procedure", add 
label define label_xh021 23 "Partial imputation", add 
...
label define label_xh021 33 "Particular 1st prof field not applicable", add 
...
label define label_xh022 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xh022 22 "Imputed using the Group Median procedure", add 
label define label_xh022 23 "Partial imputation", add 
...
label define label_xh022 33 "Particular 1st prof field not applicable", add 
...
label define label_xk014 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xk014 22 "Imputed using the Group Median procedure", add 
label define label_xk014 23 "Partial imputation", add 
...
label define label_xk014 33 "Particular 1st prof field not applicable", add 
...
label define label_xk025 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xk025 22 "Imputed using the Group Median procedure", add 
label define label_xk025 23 "Partial imputation", add 
...
label define label_xk025 33 "Particular 1st prof field not applicable", add 
...
label define label_xk035 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xk035 22 "Imputed using the Group Median procedure", add 
label define label_xk035 23 "Partial imputation", add 
...
label define label_xk035 33 "Particular 1st prof field not applicable", add 
...
des
 ...
 save publicrevenues2001.dta, replace
