...
*   
clear                                                     
insheet using "$PATH\Academic Calendar\Data\ic2011_data_stata.csv", comma clear
label data "dct_ic2011"
...
label define label_appdate 1 "Fall 2010", add 
label define label_appdate 2 "Fall 2011", add 
...
label define label_satactdt 1 "Fall 2010", add 
label define label_satactdt 2 "Fall 2011", add 
...
label values tuitpl4 label_disab
label define label_distnced -1 "Not reported" 
label define label_distnced -2 "Not applicable", add 
label define label_distnced 1 "3 percent or less", add 
label define label_distnced 2 "More than 3 percent", add 
...
gen year=2011
sort unitid
save "$PATH\Academic Calendar\Data\institution2011.dta", replace
