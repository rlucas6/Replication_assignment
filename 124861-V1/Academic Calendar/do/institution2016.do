...
*
clear
insheet using "$PATH\Academic Calendar\Data\ic2016_data_stata.csv", comma clear
label data "dct_ic2016"
...
label variable vet5     "Member of Servicemembers Opportunity Colleges"
...
label define label_relaffil 106 "Muslim",add
...
label define label_distcrs 2 "No",add
...
gen year=2016
sort unitid
save "$PATH\Academic Calendar\Data\institution2016.dta", replace
