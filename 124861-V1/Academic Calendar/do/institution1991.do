...
*                                     
clear                   
insheet using "$PATH\Academic Calendar\Data\ic1991_data_stata.csv", comma clear
label data "dct_ic1991_c"
...
label define label_libfac 2 "Do not have library but support a shared library with other institutions", add 
...
gen year=1991
sort unitid
save "$PATH\Academic Calendar\Data\institution1991.dta", replace
