...
*
clear
insheet using "$PATH\Academic Calendar\Data\gr2015_data_stata.csv", comma clear
label data "dct_gr2015"
...
label define label_section 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2009 subcohort (4-yr institution)"
label define label_section 2 "Bachelor^s or equiv 2009 subcohort (4-yr institution)",add
label define label_section 3 "Other degree/certif-seeking 2009 subcohort (4-yr institution)",add
label define label_section 4 "Degree/certif-seeking students 2012 cohort ( 2-yr )",add
label values section label_section
label define label_cohort 1 "Bachelor^s/ equiv +  other degree/certif-seeking 2009 subcohorts (4-yr institution)"
label define label_cohort 2 "Bachelor^s or equiv 2009  subcohort (4-yr institution)",add
label define label_cohort 3 "Other degree/certif-seeking 2009 subcohort (4-yr institution)",add
label define label_cohort 4 "Degree/certif-seeking students 2012 cohort ( 2-yr institution)",add
...
*Represented Majority defined as Asian + White
gen represented=grasiat+grnhpit+grwhitt
gen urmgrads=grtotlt-represented
rename grtotlw womengrads
rename grtotlm mengrads
rename grtotlt allgrads
rename grwhitt whitegrads
...
sort unitid
gen year=2009
save "$PATH\Academic Calendar\Data\grad2009.dta", replace
